const users = {
  ...
  'users.detail.mfa.methods.hint': 'With none selected there is no restriction: every usable method is offered.',
  'users.detail.mfa.methods.sms': 'SMS',
  'users.detail.mfa.methods.email': 'E-mail',
  'users.detail.mfa.methods.totpNote': 'The authenticator app is always offered; once enrolled it cannot be turned off here.',
