const users = {
  ...
  'users.detail.mfa.required.enabled': 'Second step is now required for this user.',
  'users.detail.mfa.required.disabled': 'Second step is no longer required.',
  'users.detail.mfa.required.failed': 'Could not change the second-step requirement.',
  'users.detail.mfa.methods.title': 'Methods offered',
  'users.detail.mfa.methods.hint': 'Ticked methods are offered to this user. Untick one to withdraw it; all ticked means no restriction.',
  'users.detail.mfa.methods.sms': 'SMS',
  'users.detail.mfa.methods.email': 'E-mail',
  'users.detail.mfa.methods.totp': 'Authenticator app',
  'users.detail.mfa.methods.totpNote': 'Lockout guard: if no other method is usable for this user, the authenticator app is offered even when unticked.',
  'users.detail.mfa.methods.saved': 'Method restriction updated.',
  'users.detail.mfa.methods.failed': 'Could not change the method restriction.',
