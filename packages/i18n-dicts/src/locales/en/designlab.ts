const designlab = {
  "designlab.workspace.components": "Components",
  "designlab.workspace.recipes": "Recipes",
  "designlab.workspace.catalog.foundations": "Foundations workspace",
  "designlab.workspace.catalog.components": "Component catalog",
  "designlab.workspace.catalog.recipes": "Recipes workspace",
  "designlab.workspace.catalog.pages": "Pages workspace",
  "designlab.workspace.catalog.ecosystem": "Ecosystem workspace",
  "designlab.lens.foundations.badge": "System foundations",
  "designlab.lens.foundations.title": "System language and foundation rules",
  "designlab.lens.foundations.note":
    "Theme, tokens, accessibility and runtime helpers are treated here as system-level references.",
  "designlab.lens.foundations.useWhen":
    "When clarifying design language, accessibility and runtime decisions before choosing a component.",
  "designlab.lens.components.badge": "UI component catalog",
  "designlab.lens.components.title": "Reusable UI catalog",
  "designlab.lens.components.note":
    "Primitive and composite component families are listed here through a single catalog model.",
  "designlab.lens.components.useWhen":
    "When searching for a standalone API, prop contract and reusable building block.",
  "designlab.lens.recipes.badge": "Workflow recipes",
  "designlab.lens.recipes.title": "Reusable product flows",
  "designlab.lens.recipes.note":
    "Workflow and state recipes built with multiple components are treated here as product patterns.",
  "designlab.lens.recipes.useWhen":
    "When shaping search/filter, approval/review or empty/error/loading flows.",
  "designlab.lens.pages.badge": "Page templates",
  "designlab.lens.pages.title": "Full-page shells and templates",
  "designlab.lens.pages.note":
    "Dashboard, CRUD, detail and settings page-level compositions are presented here through a more editorial showcase.",
  "designlab.lens.pages.useWhen":
    "When looking for full-page examples, app shell and page container-level solutions.",
  "designlab.lens.ecosystem.badge": "Enterprise extensions",
  "designlab.lens.ecosystem.title": "Pro data surfaces and enterprise tools",
  "designlab.lens.ecosystem.note":
    "Enterprise-grade data grids, admin shells, analytics dashboards and premium lane extensions are presented here.",
  "designlab.lens.ecosystem.useWhen":
    "When looking for pro/enterprise data surfaces, advanced grids, admin shells or premium extensions.",
  "designlab.foundationFamily.theme_tokens.title": "Theme, Tokens & Appearance",
  "designlab.foundationFamily.theme_tokens.description":
    "Collects theme registry, density and appearance decisions under a single governance profile.",
  "designlab.foundationFamily.theme_tokens.benchmark":
    "MUI Theme + Ant Design Tokens",
  "designlab.foundationFamily.theme_tokens.badges.theme": "Theme",
  "designlab.foundationFamily.theme_tokens.badges.tokens": "Tokens",
  "designlab.foundationFamily.theme_tokens.badges.appearance": "Appearance",
  "designlab.foundationFamily.a11y_i18n.title": "Accessibility & i18n",
  "designlab.foundationFamily.a11y_i18n.description":
    "Governs focus, locale, empty-state language and semantic helper surfaces.",
  ...
  "designlab.foundationFamily.a11y_i18n.badges.locale": "Locale",
  "designlab.foundationFamily.dev_diagnostics.title":
    "Dev, QA & Diagnostics",
  "designlab.foundationFamily.dev_diagnostics.description":
    "Brings playground, diagnostics and release-gate surfaces together in the same quality lane.",
  ...
  "designlab.foundationFamily.dev_diagnostics.badges.diagnostics":
    "Diagnostics",
  "designlab.foundationFamily.dev_diagnostics.badges.release": "Release",
  "designlab.foundationFamily.runtime_utilities.title":
    "Runtime, Hooks & Utilities",
  "designlab.foundationFamily.runtime_utilities.description":
    "Presents the hook, helper and runtime contract layer in the same library language while keeping it distinct from components.",
  "designlab.foundationFamily.runtime_utilities.benchmark":
    "MUI Utils + Ant Design App helpers",
  "designlab.foundationFamily.runtime_utilities.badges.hooks": "Hooks",
  ...
  "designlab.sidebar.title.foundations": "Foundations catalog",
  "designlab.sidebar.title.components": "Component catalog",
  "designlab.sidebar.title.recipes": "Recipe catalog",
  "designlab.sidebar.title.pages": "Page template catalog",
  "designlab.sidebar.help.foundations":
    "Browse token, theme, runtime and system foundation families with their own catalog tree and context card.",
  ...
  "designlab.sidebar.help.ecosystem":
    "Browse enterprise extensions grouped by domain. Each card shows the extension tier and surface classification.",
  "designlab.sidebar.tooltip.ecosystem": "Extension Explorer help",
  "designlab.sidebar.tooltip.components": "Design System Explorer help",
  "designlab.sidebar.tooltip.recipes": "Recipe Explorer help",
  "designlab.sidebar.mode.title": "Workspace mode",
  "designlab.sidebar.context.title": "Selected context",
  "designlab.sidebar.context.empty": "No active selection yet",
  "designlab.sidebar.context.foundations": "Foundations",
  "designlab.sidebar.context.recipes": "Recipes",
  "designlab.sidebar.context.pages": "Pages",
  "designlab.sidebar.context.ecosystem": "Ecosystem",
  "designlab.sidebar.section.title": "Library Sections",
  "designlab.rightRail.open": "Open right panel",
  "designlab.rightRail.close": "Close right panel",
  "designlab.taxonomy.sections.foundations.title": "Foundations",
  "designlab.taxonomy.sections.foundations.description":
    "Theme, tokens, motion and the core appearance contract of the system.",
  "designlab.taxonomy.sections.components.title": "Components",
  "designlab.taxonomy.sections.components.description":
    "A full UI library surface covering primitives, forms, collections, overlays and feedback.",
  "designlab.taxonomy.sections.recipes.title": "Recipes",
  "designlab.taxonomy.sections.recipes.description":
    "Repeatable workflow, state and task-oriented usage patterns.",
  "designlab.taxonomy.sections.pages.title": "Pages / Templates",
  "designlab.taxonomy.sections.pages.description":
    "Page skeletons, page shell building blocks and full template surfaces.",
  "designlab.taxonomy.sections.patterns.title": "Flows",
  "designlab.taxonomy.sections.patterns.description":
    "Repeatable data workflows, grid extensions and multi-component solution recipes.",
  "designlab.taxonomy.sections.templates.title": "Pages",
  "designlab.taxonomy.sections.templates.description":
    "Page shells, layouts and larger working surfaces.",
  "designlab.taxonomy.sections.visualization.title": "Data Visualization",
  "designlab.taxonomy.sections.visualization.description":
    "Charts, dashboards and analytical presentation surfaces.",
  "designlab.taxonomy.sections.ai_ux.title": "AI Experiences",
  "designlab.taxonomy.sections.ai_ux.description":
    "AI-native prompts, confidence, citations and assisted review flows.",
  "designlab.taxonomy.sections.content_language.title": "Content & Language",
  "designlab.taxonomy.sections.content_language.description":
    "Accessibility, language rules, localization and content behavior.",
  "designlab.taxonomy.sections.governance.title": "Release & Governance",
  "designlab.taxonomy.sections.governance.description":
    "Release, diagnostics, migration and operational governance surfaces.",
  "designlab.taxonomy.sections.ecosystem.title": "Enterprise Extensions",
  "designlab.taxonomy.sections.ecosystem.description":
    "Pro/enterprise data surfaces, advanced grid, charts, admin shells and premium lane extensions.",
  "designlab.taxonomy.badges.adapter": "Legacy adapter",
  "designlab.taxonomy.adapterNotice.title": "This view opened from a legacy Design Lab entry.",
  "designlab.taxonomy.adapterNotice.description":
    "{source} now resolves through an adapter into the {target} layer.",
  "designlab.taxonomy.adapterNotice.cta.visualization": "Open Data Display & Collections",
  "designlab.taxonomy.adapterNotice.cta.ai_ux": "Open AI Workflows recipe",
  "designlab.sidebar.search.foundations.placeholder":
    "Search foundations...",
  "designlab.sidebar.search.components.placeholder": "Search components...",
  "designlab.sidebar.search.recipes.placeholder": "Search recipes...",
  "designlab.sidebar.search.pages.placeholder": "Search page templates...",
  "designlab.sidebar.search.ecosystem.placeholder": "Search extensions...",
  "designlab.sidebar.search.aria": "Search inside Design Lab",
  "designlab.sidebar.foundationTree.title": "Foundation families",
  "designlab.sidebar.productTree.title": "Component tree",
  "designlab.sidebar.pageList.title": "Page families",
  "designlab.sidebar.recipeList.title": "Recipes",
  "designlab.sidebar.recipe.count": "{count} recipe",
  "designlab.sidebar.page.count": "{count} template",
  "designlab.sidebar.page.empty.search":
    'No page template matched "{query}" under {lens}.',
  "designlab.sidebar.page.empty.default":
    "No page template available under {lens}.",
  "designlab.sidebar.page.empty.hint":
    "Try another page family or clear the search to inspect other templates.",
  "designlab.sidebar.recipe.empty.search":
    'No recipe matched "{query}" under {lens}.',
  "designlab.sidebar.recipe.empty.default": "No recipe available under {lens}.",
  "designlab.sidebar.recipe.empty.hint":
    "Try another lens or clear the search to see other recipe families.",
  "designlab.sidebar.ecosystem.count": "{count} extension",
  "designlab.sidebar.ecosystem.empty.search":
    'No extension matched "{query}" under {lens}.',
  "designlab.sidebar.ecosystem.empty.default":
    "No extension available under {lens}.",
  "designlab.sidebar.platformContracts.title": "Platform Contracts",
  "designlab.sidebar.platformContracts.description":
    "System-level contract and compliance references.",
  "designlab.breadcrumb.docs": "Docs",
  "designlab.breadcrumb.library": "UI Library",
  "designlab.hero.label.component": "Component",
  "designlab.hero.label.recipe": "Recipe",
  "designlab.hero.placeholder.foundations": "Select foundation family",
  "designlab.hero.placeholder.component": "Select component",
  "designlab.hero.placeholder.recipe": "Select recipe",
  "designlab.hero.placeholder.page": "Select page template",
  "designlab.hero.placeholder.description.foundations":
    "Select a foundation family from the left menu to inspect tokens, runtime and system governance references.",
  "designlab.hero.placeholder.description.component":
    "Select a component from the left menu to inspect live demos, API and quality details.",
  "designlab.hero.placeholder.description.recipe":
    "Select a recipe from the left menu to inspect canonical screen compositions.",
  "designlab.hero.placeholder.description.page":
    "Select a page template from the left menu to inspect layout shells, page examples and adoption context.",
  "designlab.hero.placeholder.ecosystem": "Select extension",
  "designlab.hero.placeholder.description.ecosystem":
    "Select an extension from the left menu to inspect data surfaces, API contracts and enterprise quality gates.",
  "designlab.copy.success": "Copied",
  "designlab.copy.failure": "Copy failed",
  "designlab.tabs.general.label": "General",
  "designlab.tabs.general.description":
    "Identity, release status and quick decision context",
  "designlab.tabs.general.description.foundations":
    "Foundation identity, governance and system-level decision context",
  "designlab.tabs.general.description.components":
    "Identity, release status and quick decision context",
  "designlab.tabs.general.description.recipes":
    "Workflow identity, owner blocks and quick decision context",
  "designlab.tabs.general.description.pages":
    "Template identity, layout intent and quick page context",
  "designlab.tabs.general.label.ecosystem": "General",
  "designlab.tabs.general.description.ecosystem":
    "Extension identity, tier classification and quick decision context",
  "designlab.tabs.demo.label": "Preview",
  "designlab.tabs.demo.description":
    "Live demo and variant surface in a single active workspace",
  "designlab.tabs.demo.description.foundations":
    "Theme, token and runtime preview surfaces in a single active workspace",
  "designlab.tabs.demo.description.components":
    "Live demo and variant surface in a single active workspace",
  "designlab.tabs.demo.description.recipes":
    "Live recipe, reference notes and handoff surface in one active workspace",
  "designlab.tabs.demo.description.pages":
    "Template preview, layout shells and page examples in one active workspace",
  "designlab.tabs.demo.label.ecosystem": "Preview",
  "designlab.tabs.demo.description.ecosystem":
    "Data surface preview and extension showcase in one active workspace",
  "designlab.tabs.overview.label": "Overview",
  "designlab.tabs.overview.description":
    "Short summary, status and decision framing",
  "designlab.tabs.overview.description.foundations":
    "System summary, foundation references and governance framing",
  "designlab.tabs.overview.description.components":
    "Short summary, status and catalog decision framing",
  "designlab.tabs.overview.description.recipes":
    "Workflow summary, owner blocks and handoff framing",
  "designlab.tabs.overview.description.pages":
    "Template families, layout regions and adoption framing",
  "designlab.tabs.overview.label.ecosystem": "Overview",
  "designlab.tabs.overview.description.ecosystem":
    "Extension summary, domain grouping and enterprise adoption framing",
  "designlab.tabs.api.label": "API",
  "designlab.tabs.api.description":
    "Import, props, variant axes and state model",
  "designlab.tabs.api.description.foundations":
    "Token, runtime and foundation utility contracts",
  "designlab.tabs.api.description.components":
    "Import, props, variant axes and state model",
  "designlab.tabs.api.description.recipes":
    "Recipe contract, component bindings and handoff model",
  "designlab.tabs.api.description.pages":
    "Page contract, layout regions and dependency model",
  "designlab.tabs.api.label.ecosystem": "API",
  "designlab.tabs.api.description.ecosystem":
    "Extension contract, pro API surface and dependency model",
  "designlab.tabs.ux.label": "UX",
  "designlab.tabs.ux.description":
    "UX catalog alignment and north-star bindings",
  "designlab.tabs.ux.description.foundations":
    "Design language, accessibility and theme alignment",
  "designlab.tabs.ux.description.components":
    "UX catalog alignment and north-star bindings",
  "designlab.tabs.ux.description.recipes":
    "Workflow clarity, state flow and handoff experience",
  "designlab.tabs.ux.description.pages":
    "Page clarity, layout ergonomics and navigation experience",
  "designlab.tabs.ux.label.ecosystem": "UX",
  "designlab.tabs.ux.description.ecosystem":
    "Extension clarity, surface ergonomics and enterprise experience",
  "designlab.tabs.quality.label": "Quality",
  "designlab.tabs.quality.description": "Gate, regression and usage evidence",
  "designlab.tabs.quality.description.foundations":
    "Theme, i18n, accessibility and runtime quality gates",
  "designlab.tabs.quality.description.components":
    "Gate, regression and usage evidence",
  "designlab.tabs.quality.description.recipes":
    "Workflow, binding and lifecycle quality evidence",
  "designlab.tabs.quality.description.pages":
    "Template adoption, layout validation and page quality gates",
  "designlab.tabs.quality.label.ecosystem": "Quality",
  "designlab.tabs.quality.description.ecosystem":
    "Enterprise gates, tier compliance and extension quality evidence",
  "designlab.componentContracts.spinner.label": "Loading",
  "designlab.componentContracts.empty.description": "No records found.",
  "designlab.componentContracts.pagination.navigationLabel": "Pagination",
  "designlab.componentContracts.pagination.previousButtonLabel": "Previous",
  "designlab.componentContracts.pagination.nextButtonLabel": "Next",
  "designlab.componentContracts.pagination.previousPageAriaLabel":
    "Previous page",
  "designlab.componentContracts.pagination.nextPageAriaLabel": "Next page",
  "designlab.componentContracts.pagination.pageAriaLabel": "Page {page}",
  "designlab.componentContracts.pagination.pageIndicatorLabel":
    "Page {currentPage} / {pageCount}",
  "designlab.componentContracts.pagination.totalItemsLabel": "{count} records",
  "designlab.componentContracts.pagination.mode.server": "Server-side mode",
  "designlab.componentContracts.pagination.mode.client": "Client-side mode",
  "designlab.componentContracts.datePicker.emptyValueLabel": "Select date",
  "designlab.componentContracts.timePicker.emptyValueLabel": "Select time",
  ...
  "designlab.componentContracts.jsonViewer.emptyNodeDescription":
    "This node is empty.",
  "designlab.componentContracts.anchorToc.title": "On this page",
  ...
  "designlab.componentContracts.linkInline.externalScreenReaderLabel":
    "External link",
  "designlab.componentContracts.tourCoachmarks.title": "Guided tour",
  "designlab.componentContracts.tourCoachmarks.skipLabel": "Skip",
  "designlab.componentContracts.tourCoachmarks.closeLabel": "Close",
  "designlab.componentContracts.tourCoachmarks.previousLabel": "Back",
  "designlab.componentContracts.tourCoachmarks.nextStepLabel": "Next step",
  "designlab.componentContracts.tourCoachmarks.finishLabel": "Finish",
  "designlab.componentContracts.tourCoachmarks.readonlyFinishLabel":
    "Tour complete",
  "designlab.componentContracts.themePreviewCard.titleText": "Title text",
  "designlab.componentContracts.themePreviewCard.secondaryText":
    "Secondary text",
  "designlab.componentContracts.themePreviewCard.saveLabel": "Save",
  ...
  "designlab.componentContracts.tree.emptyFallbackDescription":
    "No records found.",
  "designlab.componentContracts.tree.expandNodeAriaLabel": "Expand branch",
  "designlab.componentContracts.tree.collapseNodeAriaLabel": "Collapse branch",
  "designlab.componentContracts.treeTable.treeColumnLabel": "Structure",
  "designlab.componentContracts.treeTable.emptyFallbackDescription":
    "No records found.",
  "designlab.componentContracts.treeTable.expandNodeAriaLabel": "Expand branch",
  "designlab.componentContracts.treeTable.collapseNodeAriaLabel":
    "Collapse branch",
  "designlab.componentContracts.contextMenu.buttonLabel": "Context menu",
  "designlab.componentContracts.contextMenu.contextTriggerHint":
    "Right click to open the context menu",
  "designlab.componentContracts.contextMenu.menuAriaLabel": "Context menu",
  "designlab.componentContracts.agGridServer.loadingLabel": "Loading...",
  ...
  "designlab.componentContracts.entityGridTemplate.themeLabel": "Theme",
  "designlab.componentContracts.entityGridTemplate.quickFilterLabel": "Filter",
  "designlab.componentContracts.entityGridTemplate.variantLabel": "Variant",
  ...
  "designlab.componentContracts.entityGridTemplate.csvVisibleLabel":
    "CSV (Visible)",
  "designlab.componentContracts.entityGridTemplate.csvAllLabel": "CSV (All)",
  "designlab.componentContracts.entityGridTemplate.exportFileBaseName": "data",
  "designlab.componentContracts.entityGridTemplate.exportSheetName": "Data",
  ...
  "designlab.componentContracts.entityGridTemplate.densityStatusOverride":
    "This grid uses a local density override.",
  ...
  "designlab.componentContracts.entityGridTemplate.resetFiltersSuccessLabel":
    "Filters were reset.",
  "designlab.componentContracts.entityGridTemplate.pageSizeLabel": "Page size:",
  "designlab.componentContracts.entityGridTemplate.recordCountLabel":
    "{start}-{end} / {total} records",
  ...
  "designlab.componentContracts.entityGridTemplate.previousPageLabel":
    "Previous page",
  "designlab.componentContracts.entityGridTemplate.nextPageLabel": "Next page",
  "designlab.componentContracts.entityGridTemplate.lastPageLabel": "Last page",
  ...
  "designlab.componentContracts.entityGridTemplate.selectedVariantIncompatibleLabel":
    "This variant is incompatible with the current grid structure.",
  "designlab.componentContracts.entityGridTemplate.variantSaveBlockedLabel":
    "This variant cannot be saved because it is incompatible.",
  ...
  "designlab.componentContracts.entityGridTemplate.menuSelectLabel":
    "Apply view",
  "designlab.componentContracts.entityGridTemplate.menuRenameLabel": "Rename",
  "designlab.componentContracts.entityGridTemplate.menuUnsetDefaultLabel":
    "Remove from my defaults",
  ...
  "designlab.componentContracts.entityGridTemplate.menuMoveToGlobalLabel":
    "Move to global",
  "designlab.componentContracts.entityGridTemplate.menuDeleteLabel": "Delete",
  "designlab.componentContracts.entityGridTemplate.saveLabel": "Save",
  "designlab.componentContracts.entityGridTemplate.cancelLabel": "Cancel",
  ...
  "designlab.componentContracts.entityGridTemplate.saveTitle": "Save",
  ...
  "designlab.componentContracts.entityGridTemplate.localeText.blanks":
    "(Blank)",
  "designlab.componentContracts.entityGridTemplate.localeText.page": "Page",
  "designlab.componentContracts.entityGridTemplate.localeText.more": "More",
  "designlab.componentContracts.entityGridTemplate.localeText.to": "-",
  "designlab.componentContracts.entityGridTemplate.localeText.of": "of",
  "designlab.componentContracts.entityGridTemplate.localeText.next": "Next",
  "designlab.componentContracts.entityGridTemplate.localeText.last": "Last",
  "designlab.componentContracts.entityGridTemplate.localeText.first": "First",
  ...
  "designlab.componentContracts.entityGridTemplate.localeText.clearFilters":
    "Clear all filters",
  "designlab.componentContracts.entityGridTemplate.localeText.equals": "Equals",
  ...
  "designlab.componentContracts.entityGridTemplate.localeText.endsWith":
    "Ends with",
  "designlab.componentContracts.entityGridTemplate.localeText.blank": "Blank",
  ...
  "designlab.componentContracts.entityGridTemplate.localeText.advancedFilterApply":
    "Apply",
  "designlab.general.component.empty": "Select a component from the left.",
  "designlab.general.recipe.empty": "Select a recipe from Recipe Explorer.",
  "designlab.general.component.title": "Component Snapshot",
  "designlab.general.component.description":
    "Instead of a wide hero band, component identity, quick status and import action are collected in a single tab here.",
  "designlab.general.component.primarySummary": "Primary summary",
  "designlab.general.component.import.label": "Import",
  "designlab.general.component.import.action": "Copy import",
  "designlab.general.component.releaseIdentity": "Release & Identity",
  "designlab.general.component.primaryLens.note":
    "The primary discovery lens derived from the component taxonomy group.",
  "designlab.general.component.package": "Package",
  "designlab.general.component.release": "Release",
  "designlab.general.component.contractTags": "Contract / Tags",
  "designlab.general.component.noTags": "No tags",
  "designlab.general.recipe.title": "Recipe Snapshot",
  "designlab.general.recipe.description":
    "Recipe identity, owner block set and quick coverage signals are collected in a single tab here.",
  "designlab.general.recipe.identity": "Recipe Identity",
  "designlab.general.recipe.primaryLens.note":
    "The primary discovery lens derived from recipe intent and owner block composition.",
  "designlab.general.recipe.tracksThemes": "Tracks & Themes",
  "designlab.general.recipe.sectionsGates": "Sections & Gates",
  "designlab.general.recipe.noBindings": "No bindings found",
  "designlab.metadata.primaryLens": "Primary Lens",
  "designlab.metadata.track": "Track",
  "designlab.metadata.group": "Group",
  "designlab.metadata.demo": "Demo",
  "designlab.metadata.usage": "Usage",
  "designlab.metadata.ownerBlocks": "Owner Blocks",
  "designlab.metadata.tracks": "Tracks",
  "designlab.metadata.sections": "Sections",
  "designlab.metadata.themes": "Themes",
  "designlab.metadata.mode.recipeExplorer": "Recipe Explorer",
  "designlab.metadata.mode.noSelection": "No selection",
  "designlab.metadata.notAvailable": "—",
  "designlab.track.newPackages.label": "New Packages",
  "designlab.track.newPackages.note":
    "New component family generated through the active wave contract.",
  "designlab.track.currentSystem.label": "Current System",
  "designlab.track.currentSystem.note":
    "Previously exported surface that is already consumed in the repo.",
  "designlab.track.roadmap.label": "Roadmap",
  "designlab.track.roadmap.note":
    "Planned component backlog that is not exported yet.",
  "designlab.usageRecipes.basic.title": "Basic usage",
  "designlab.usageRecipes.basic.description":
    "Safe starting recipe with package import and minimum API surface.",
  "designlab.usageRecipes.controlled.title": "Controlled state",
  "designlab.usageRecipes.controlled.description":
    "Usage pattern managed through form or shell state.",
  "designlab.usageRecipes.governed.title": "Ops / quality note",
  "designlab.usageRecipes.governed.description":
    "Usage note aligned with wave gate, browser doctor and registry contract.",
  "designlab.overview.empty": "Select a component from the left.",
  "designlab.overview.workspace.title": "Overview Workspace",
  "designlab.overview.workspace.description":
    "Release, adoption, migration, visual contract, theme and recipe system open here as second-level workspace panels instead of stacking in one tab.",
  "designlab.overview.workspace.noPanels":
    "No overview panel is available for this component.",
  "designlab.common.tabbed": "Tabbed",
  "designlab.common.panelCount": "{count} panel",
  "designlab.common.panelCountPlural": "{count} panels",
  "designlab.component.api.empty": "Select a component to inspect API details.",
  "designlab.component.api.workspace.title": "API Workspace",
  "designlab.component.api.workspace.description":
    "Import, model, props and usage open as second-level workspace panels instead of stacking in one long tab.",
  "designlab.component.api.import": "Import",
  "designlab.component.api.import.planned": "Planned item — import unavailable",
  "designlab.component.api.registryFields": "Registry Fields",
  "designlab.component.api.kind": "Kind",
  "designlab.component.api.taxonomy": "Taxonomy",
  "designlab.component.api.subgroup": "Subgroup",
  "designlab.component.api.track": "Track",
  "designlab.component.api.model.title": "API Model",
  "designlab.component.api.model.noCatalog":
    "There is no detailed API catalog entry for this component yet.",
  "designlab.component.api.model.variantAxes": "Variant Axes",
  "designlab.component.api.model.stateModel": "State Model",
  "designlab.component.api.model.previewFocus": "Preview Focus",
  "designlab.component.api.model.regressionFocus": "Regression Focus",
  "designlab.component.ux.empty": "Select a component to inspect UX alignment.",
  "designlab.component.ux.alignment": "UX Alignment",
  "designlab.component.ux.northStar": "North Star Sections",
  "designlab.component.ux.primaryThemeMissing": "No primary theme",
  "designlab.component.ux.primarySubthemeMissing": "No primary subtheme",
  "designlab.component.ux.sectionMissing": "No section",
  "designlab.component.quality.empty":
    "Select a component to inspect quality evidence.",
  "designlab.component.quality.workspace.title": "Quality Workspace",
  "designlab.component.quality.workspace.description":
    "Gate and usage evidence are separated into second-level workspace panels to keep quality review focused.",
  "designlab.component.quality.gates": "Quality Gates",
  "designlab.component.quality.usage": "Usage Evidence",
  "designlab.component.quality.noGates": "No quality gate",
  "designlab.recipe.overview.empty": "Select a recipe from Recipe Explorer.",
  "designlab.recipe.overview.workspace.title": "Recipe Workspace",
  "designlab.recipe.overview.workspace.description":
    "Recipe summary, coverage and consumer flow open as controlled workspace panels instead of a long document.",
  "designlab.recipe.overview.summary": "Recipe Summary",
  "designlab.recipe.overview.quickStatus": "Recipe Quick Status",
  "designlab.recipe.overview.quickStatus.ownerBlocks.note":
    "Canonical component count inside this recipe.",
  "designlab.recipe.overview.quickStatus.tracks.note":
    "Number of release tracks covered by the recipe.",
  "designlab.recipe.overview.quickStatus.sections.note":
    "Number of covered north-star sections.",
  "designlab.recipe.overview.quickStatus.themes.note":
    "Bound UX theme and subtheme surface.",
  "designlab.recipe.overview.trackCoverage": "Track Coverage",
  "designlab.recipe.overview.northStarCoverage": "North Star Coverage",
  "designlab.recipe.overview.themeCoverage": "Theme Coverage",
  "designlab.recipe.overview.qualityCoverage": "Quality Coverage",
  "designlab.recipe.overview.noTrackBinding": "No track binding",
  "designlab.recipe.overview.noSectionBinding": "No section binding",
  "designlab.recipe.overview.noThemeBinding": "No theme binding",
  "designlab.recipe.overview.noQualityGates": "No quality gate",
  "designlab.recipe.overview.flow.eyebrow": "Consumer Flow",
  "designlab.recipe.overview.flow.title": "Recipe adoption contract",
  "designlab.recipe.overview.flow.description":
    "Application teams should first decide at recipe level and only then drill into missing owner block detail.",
  "designlab.recipe.overview.flow.step1": "Select recipe",
  "designlab.recipe.overview.flow.step1.note":
    "First match the screen problem with a ready recipe family.",
  "designlab.recipe.overview.flow.step2": "Lock preset",
  "designlab.recipe.overview.flow.step2.note":
    "Theme, density and UX section decisions should be fixed at recipe level.",
  "designlab.recipe.overview.flow.step3": "Drill into component",
  "designlab.recipe.overview.flow.step3.note":
    "Open primitive detail only if a block or variant is still missing.",
  "designlab.recipe.api.empty":
    "Select a recipe to inspect the consume contract.",
  "designlab.recipe.api.workspace.title": "Consume Contract Workspace",
  "designlab.recipe.api.workspace.description":
    "Recipe import, registry binding and consumer handoff surface open in controlled workspace panels instead of a single long flow.",
  "designlab.recipe.api.listLabel": "Recipe API workspace panels",
  "designlab.recipe.api.contract": "Contract",
  "designlab.recipe.api.binding": "Binding",
  "designlab.recipe.api.usage": "Usage",
  "designlab.recipe.api.contractTitle": "Recipe Contract",
  "designlab.recipe.api.bindingTitle": "Registry Binding",
  "designlab.recipe.api.binding.recipeId.note":
    "Canonical recipe id inside Design Lab.",
  "designlab.recipe.api.binding.ownerBlocks.note":
    "Official block set that the consumer screen will compose.",
  "designlab.recipe.api.binding.tracks.note":
    "Release tracks covered by this recipe.",
  "designlab.recipe.api.binding.contract.note":
    "Source contract for the recipe system.",
  "designlab.recipe.api.compose.title": "Compose recipe shell",
  "designlab.recipe.api.compose.description":
    "Compose the recipe owner block set directly on the same surface.",
  "designlab.recipe.api.handoff.title": "Consumer handoff",
  "designlab.recipe.api.handoff.description":
    "Application teams should carry the recipe decision first, then open primitive variants only when needed.",
  "designlab.recipe.quality.empty":
    "Select a recipe to inspect quality evidence.",
  "designlab.recipe.quality.workspace.title": "Recipe Quality Workspace",
  "designlab.recipe.quality.workspace.description":
    "Gate and lifecycle evidence are separated into second-level panels to keep recipe quality review focused.",
  "designlab.recipe.quality.listLabel": "Recipe quality workspace panels",
  ...
  "designlab.recipe.quality.lifecycle.stable.note":
    "Number of stable blocks inside the recipe.",
  "designlab.recipe.quality.lifecycle.beta.note":
    "Number of blocks that are not stabilized yet.",
  "designlab.recipe.quality.lifecycle.liveDemo.note":
    "Number of blocks with live demo support.",
  "designlab.showcase.previewPanels.live.label": "Live",
  "designlab.showcase.previewPanels.live.note":
    "Live demo and interactive variant surface.",
  "designlab.showcase.previewPanels.reference.label": "Reference",
  "designlab.showcase.previewPanels.reference.note":
    "Usage notes, contract comments and reference panels.",
  "designlab.showcase.previewPanels.recipe.label": "Recipe",
  "designlab.showcase.previewPanels.recipe.note":
    "Recipe lens, composition and consumer-focused blocks.",
  "designlab.showcase.previewSurface.live": "LIVE",
  "designlab.showcase.previewSurface.reference": "REFERENCE",
  "designlab.showcase.previewSurface.recipe": "RECIPE",
  "designlab.showcase.preview.workspace.title": "Preview Workspace",
  "designlab.showcase.preview.workspace.description.recipes":
    "Recipe composition opens in a single active preview panel. You can browse live blocks, reference notes and recipe handoff across separate tabs.",
  "designlab.showcase.preview.workspace.description.components":
    "Live demo and reference notes open in a single active preview workspace. Instead of one long page flow, only the selected component surface is shown.",
  "designlab.showcase.preview.workspace.listLabel.recipes":
    "Recipe preview panels",
  ...
  "designlab.showcase.preview.empty.recipe":
    "There is no visible recipe surface for the selected preview panel. Switch panels to open composition or reference blocks.",
  "designlab.showcase.preview.empty.component":
    "There is no visible demo for the selected preview panel. Open another surface from Live, Reference or Recipe.",
  "designlab.showcase.preview.selectRecipe":
    "Select a recipe to inspect demo and composition.",
  "designlab.showcase.preview.selectComponent":
    "Select a component to inspect the live showcase.",
  "designlab.showcase.preview.undefinedRecipePreview":
    "There is no custom component preview for this recipe yet.",
  "designlab.showcase.recipe.searchFilterListing.eyebrow": "Recipe",
  "designlab.showcase.recipe.searchFilterListing.title": "Policy inventory",
  "designlab.showcase.recipe.searchFilterListing.description":
    "Search, filter and result shell are collected under the same recipe contract.",
  "designlab.showcase.recipe.searchFilterListing.searchLabel": "Search",
  "designlab.showcase.recipe.searchFilterListing.densityLabel": "Density",
  "designlab.showcase.recipe.searchFilterListing.density.comfortable":
    "Comfortable",
  "designlab.showcase.recipe.searchFilterListing.density.compact": "Compact",
  "designlab.showcase.recipe.searchFilterListing.density.readonly": "Readonly",
  "designlab.showcase.recipe.searchFilterListing.savedView":
    "Saved recipe listing view",
  ...
  "designlab.showcase.recipe.searchFilterListing.summary.density.note":
    "Recipe shell density",
  "designlab.showcase.recipe.detailSummary.eyebrow": "Recipe",
  "designlab.showcase.recipe.detailSummary.title": "Wave 11 rollout detail",
  "designlab.showcase.recipe.detailSummary.description":
    "Summary, entity context and payload are read through the same inspector recipe.",
  "designlab.showcase.recipe.detailSummary.status": "Publish-ready",
  "designlab.showcase.recipe.detailSummary.summary.owners.note":
    "Canonical owner block count",
  "designlab.showcase.recipe.detailSummary.summary.doctor.note":
    "ui-library preset",
  "designlab.showcase.recipe.detailSummary.summary.adoption.label": "Adoption",
  "designlab.showcase.recipe.detailSummary.summary.adoption.note":
    "Recipe-first enforcement",
  "designlab.showcase.recipe.detailSummary.entity.subtitle":
    "Reuses page and panel compositions through data/config.",
  "designlab.showcase.recipe.detailSummary.entity.owner": "Owner",
  "designlab.showcase.recipe.detailSummary.detail.focus.value":
    "Reusable page/panel patterns",
  ...
  "designlab.showcase.recipe.detailSummary.detail.rule.value":
    "Recipe before page-level custom UI",
  "designlab.showcase.recipe.approvalReview.title": "Publish approval",
  "designlab.showcase.recipe.approvalReview.eyebrow": "Recipe",
  "designlab.showcase.recipe.approvalReview.description":
    "Checkpoint, evidence and audit flow are read through the same review recipe.",
  "designlab.showcase.recipe.approvalReview.summary":
    "Recipe publish decision is read with citation evidence and audit timeline.",
  "designlab.showcase.recipe.approvalReview.state": "Current state: {state}",
  "designlab.showcase.recipe.emptyErrorLoading.loadingLabel":
    "Preparing recipe surfaces",
  "designlab.showcase.recipe.emptyErrorLoading.retry":
    "Retry requested from recipe state",
  "designlab.showcase.recipe.aiGuidedAuthoring.title":
    "Use ApprovalReview recipe",
  "designlab.showcase.recipe.aiGuidedAuthoring.summary":
    "Use the canonical ApprovalReview recipe instead of a duplicate review shell.",
  "designlab.showcase.recipe.aiGuidedAuthoring.type": "Recipe suggestion",
  "designlab.showcase.recipe.aiGuidedAuthoring.decision":
    "Decision: {decision}",
  "designlab.showcase.component.recipeLens.eyebrow": "Recipe Lens",
  "designlab.showcase.component.recipeLens.title": "Recipe composition lens",
  "designlab.showcase.component.recipeLens.description":
    "Which screen recipes use this component and where should consumer teams take a ready composition?",
  "designlab.showcase.component.recipeLens.directRecipes": "Direct recipes",
  "designlab.showcase.component.recipeLens.consumerHandoff": "Consumer handoff",
  "designlab.showcase.component.recipeLens.badge.directOwner": "Direct owner",
  "designlab.showcase.component.recipeLens.badge.related": "Related",
  "designlab.showcase.component.recipeLens.preferredSource": "Preferred source",
  ...
  "designlab.showcase.component.recipeLens.preferredSource.note.recipe":
    "Consumer teams should start with a ready recipe family for this component.",
  "designlab.showcase.component.recipeLens.preferredSource.note.primitive":
    "There is no ready recipe; primitive composition will be used directly.",
  "designlab.showcase.component.recipeLens.primaryTrack": "Primary track",
  "designlab.showcase.component.recipeLens.primaryTrack.note":
    "Consumer teams should reference canonical recipes and theme presets within the same track.",
  "designlab.showcase.component.recipeLens.consumerRule": "Consumer rule",
  "designlab.showcase.component.recipeLens.consumerRule.description":
    "Application teams should not reinvent the screen design inside the page. First check recipe families in this lens; only design a new primitive composition if something is still missing.",
  "designlab.showcase.recipe.workspace.surface.title": "Recipe surface",
  "designlab.showcase.recipe.workspace.surface.description":
    "The live composition, contract context and consumer handoff of the recipe are read in the same card.",
  "designlab.showcase.recipe.workspace.handoff.preferredPath": "Preferred path",
  ...
  "designlab.showcase.recipe.workspace.handoff.preferredPath.note":
    "Product teams should start from these recipe families and bind only data and business rules.",
  "designlab.showcase.recipe.workspace.handoff.trackSpread": "Track spread",
  "designlab.showcase.recipe.workspace.handoff.trackSpread.note":
    "If recipe components span multiple tracks, design decisions should be locked on this surface.",
  "designlab.showcase.recipe.workspace.handoff.missingOwners": "Missing owners",
  ...
  "designlab.showcase.recipe.workspace.handoff.contractHealth.description":
    "All owner blocks match the registry. This recipe can now be used as a safe starting point for consumer screens.",
  ...
  "designlab.showcase.recipe.workspace.buildingBlocks.description":
    "Jump to any block inside the recipe and continue the review at component level.",
  ...
  "designlab.showcase.recipe.workspace.quality.title":
    "Governance and quality contract",
  "designlab.showcase.recipe.workspace.quality.description":
    "Shared quality gates, UX theme and north-star section coverage at recipe level.",
  "designlab.showcase.recipe.workspace.quality.gates": "Quality gates",
  "designlab.showcase.recipe.workspace.quality.uxAndSections":
    "UX and sections",
  "designlab.showcase.recipe.workspace.quality.noGate": "No gate",
  "designlab.showcase.recipe.workspace.quality.noTheme": "No UX theme",
  "designlab.showcase.recipe.workspace.quality.noSection":
    "No north-star section",
  "designlab.showcase.component.planned.roadmap": "Roadmap",
  "designlab.showcase.component.planned.title": "{name} is not released yet",
  "designlab.showcase.component.planned.description":
    "This item is still in planned backlog state. The live showcase stays closed until export, live demo and regression evidence are complete.",
  "designlab.showcase.component.planned.badge": "Planned item",
  "designlab.showcase.component.planned.releaseGate": "Release gate",
  "designlab.showcase.component.planned.releaseGate.value": "blocked",
  "designlab.showcase.component.planned.releaseGate.note":
    "Requires implementation, registry sync and preview.",
  "designlab.showcase.component.planned.wave": "Wave",
  "designlab.showcase.component.planned.wave.note": "Roadmap wave alignment.",
  "designlab.showcase.component.planned.northStar": "North Star",
  ...
  "designlab.showcase.component.planned.northStar.description":
    "Because this is a roadmap item, UX and quality contracts must be fixed before export.",
  "designlab.showcase.component.button.variants.title": "Variants",
  "designlab.showcase.component.button.variants.primary": "Primary action",
  "designlab.showcase.component.button.variants.secondary": "Secondary action",
  "designlab.showcase.component.button.variants.ghost": "Ghost action",
  "designlab.showcase.component.button.variants.destructive":
    "Destructive action",
  "designlab.showcase.component.button.sizes.title": "Sizes",
  "designlab.showcase.component.button.sizes.small": "Small button",
  "designlab.showcase.component.button.sizes.medium": "Medium button",
  "designlab.showcase.component.button.sizes.large": "Large button",
  "designlab.showcase.component.button.states.title": "States",
  "designlab.showcase.component.button.states.loadingLabel": "Saving changes",
  "designlab.showcase.component.button.states.save": "Save changes",
  "designlab.showcase.component.button.states.disabled": "Disabled action",
  "designlab.showcase.component.button.states.readonly": "Readonly action",
  "designlab.showcase.component.button.states.fullWidth": "Continue to review",
  "designlab.showcase.component.badge.default": "Default",
  "designlab.showcase.component.badge.info": "Info",
  "designlab.showcase.component.badge.success": "Success",
  "designlab.showcase.component.badge.warning": "Warning",
  "designlab.showcase.component.badge.danger": "Danger",
  "designlab.showcase.component.avatar.sizes.title": "Sizes",
  "designlab.showcase.component.avatar.image.title": "Image + square",
  "designlab.showcase.component.avatar.fallback.title": "Fallback states",
  "designlab.showcase.component.breadcrumb.basic.title": "Basic path",
  "designlab.showcase.component.breadcrumb.basic.admin": "Admin",
  "designlab.showcase.component.breadcrumb.basic.uiKit": "UI Library",
  "designlab.showcase.component.breadcrumb.basic.navigation": "Navigation",
  "designlab.showcase.component.breadcrumb.collapsed.title": "Collapsed trail",
  ...
  "designlab.showcase.component.breadcrumb.collapsed.libraries": "Libraries",
  ...
  "designlab.showcase.component.menuBar.shell.title": "Shell header recipe",
  "designlab.showcase.component.menuBar.shell.note":
    "The real top header navigation recipe combines active route, utility slot and high-frequency destinations in one surface.",
  ...
  "designlab.showcase.component.menuBar.constrained.note":
    "The same recipe collapses into an overflow menu when space tightens, keeping the top header stable.",
  "designlab.showcase.component.anchorToc.title": "Section map",
  "designlab.showcase.component.anchorToc.items.overview": "Overview",
  "designlab.showcase.component.anchorToc.items.ux": "UX contract",
  "designlab.showcase.component.anchorToc.items.security": "Security",
  "designlab.showcase.component.anchorToc.items.release": "Release readiness",
  "designlab.showcase.component.anchorToc.deepLink.title": "Deep-link content",
  "designlab.showcase.component.anchorToc.deepLink.overview":
    "Start here to understand the component purpose, demo surface and consumer expectation.",
  "designlab.showcase.component.anchorToc.deepLink.ux":
    "Capture the interaction contract, density rules and accessibility notes before shipping.",
  "designlab.showcase.component.anchorToc.deepLink.security":
    "Document policy constraints, readonly behavior and audit-sensitive paths on this surface.",
  "designlab.showcase.component.anchorToc.deepLink.release":
    "Close with release evidence, regression gates and consumer handoff notes.",
  "designlab.showcase.component.iconButton.intent.title": "Intent",
  "designlab.showcase.component.iconButton.intent.add": "Add item",
  "designlab.showcase.component.iconButton.intent.pin": "Pin item",
  "designlab.showcase.component.iconButton.intent.delete": "Delete item",
  "designlab.showcase.component.iconButton.states.title": "States",
  "designlab.showcase.component.iconButton.states.loading": "Loading action",
  "designlab.showcase.component.iconButton.states.locked": "Locked action",
  "designlab.showcase.component.iconButton.states.openMenu": "Open menu",
  "designlab.showcase.component.divider.horizontal.title": "Horizontal flow",
  "designlab.showcase.component.divider.horizontal.top": "Primary context",
  "designlab.showcase.component.divider.horizontal.bottom": "Secondary context",
  "designlab.showcase.component.divider.vertical.title":
    "Vertical + inline label",
  "designlab.showcase.component.divider.vertical.left": "Before",
  "designlab.showcase.component.divider.vertical.right": "After",
  "designlab.showcase.component.divider.vertical.or": "Or",
  "designlab.showcase.component.divider.semantic.title": "Semantic usage",
  "designlab.showcase.component.divider.semantic.contract": "Contract boundary",
  "designlab.showcase.component.divider.semantic.decorative":
    "Use decorative dividers only when the split has no semantic meaning.",
  "designlab.showcase.component.linkInline.links.title":
    "Internal / external links",
  "designlab.showcase.component.linkInline.links.internal":
    "Internal destination",
  "designlab.showcase.component.linkInline.links.external":
    "External destination",
  "designlab.showcase.component.linkInline.states.title": "State variations",
  "designlab.showcase.component.linkInline.states.current": "Current route",
  "designlab.showcase.component.linkInline.states.disabled": "Disabled route",
  "designlab.showcase.component.linkInline.states.secondary":
    "Secondary action",
  "designlab.showcase.component.skeleton.text": "Text rows",
  "designlab.showcase.component.skeleton.avatarText": "Avatar + text",
  "designlab.showcase.component.skeleton.card": "Card block",
  "designlab.showcase.component.skeleton.tableRow": "Table rows",
  "designlab.showcase.component.spinner.inline.title": "Inline spinner",
  "designlab.showcase.component.spinner.inline.label": "Loading inline content",
  "designlab.showcase.component.spinner.block.title": "Block spinner",
  "designlab.showcase.component.spinner.block.label": "Loading section",
  "designlab.showcase.component.spinner.overlay.title": "Overlay spinner",
  "designlab.showcase.component.spinner.overlay.label": "Loading overlay",
  "designlab.showcase.component.spinner.tone.title": "Tone + size",
  "designlab.showcase.component.spinner.tone.short": "Small neutral loading",
  "designlab.showcase.component.spinner.tone.medium": "Primary loading",
  "designlab.showcase.component.spinner.tone.inverse": "Inverse loading",
  "designlab.showcase.component.select.option.comfortable": "Comfortable",
  "designlab.showcase.component.select.option.compact": "Compact",
  "designlab.showcase.component.select.option.sharp": "Sharp",
  "designlab.showcase.component.select.activeValue": "Active density: {value}",
  "designlab.showcase.component.steps.interactive.title": "Interactive flow",
  "designlab.showcase.component.steps.interactive.draft.title": "Draft",
  "designlab.showcase.component.steps.interactive.draft.description":
    "Prepare the first version before stakeholder review.",
  "designlab.showcase.component.steps.interactive.review.title": "Review",
  "designlab.showcase.component.steps.interactive.review.description":
    "Collect feedback, approvals and open issues in one step.",
  ...
  "designlab.showcase.component.steps.interactive.release.description":
    "Publish after doctor, gate and evidence checks are complete.",
  "designlab.showcase.component.steps.vertical.title": "Vertical progress",
  "designlab.showcase.component.steps.vertical.scope.title": "Scope",
  "designlab.showcase.component.steps.vertical.scope.description":
    "Confirm rollout coverage and impacted consumers first.",
  "designlab.showcase.component.steps.vertical.preview.title": "Preview",
  "designlab.showcase.component.steps.vertical.preview.description":
    "Check the live surface, edge cases and final copy.",
  "designlab.showcase.component.steps.vertical.security.title": "Security",
  "designlab.showcase.component.steps.vertical.security.description":
    "Optional hardening and readonly controls before release.",
  "designlab.showcase.component.tag.neutral": "Neutral",
  "designlab.showcase.component.tag.approved": "Approved",
  "designlab.showcase.component.tag.pending": "Pending",
  "designlab.showcase.component.tag.blocked": "Blocked",
  "designlab.showcase.component.text.semanticPreset.title": "Semantic presets",
  "designlab.showcase.component.text.semanticPreset.display":
    "Display headline",
  "designlab.showcase.component.text.semanticPreset.heading": "Section heading",
  "designlab.showcase.component.text.semanticPreset.titleText":
    "Title preset for cards and panels.",
  "designlab.showcase.component.text.semanticPreset.body":
    "Body copy for operational narratives and supporting product detail.",
  "designlab.showcase.component.text.semanticPreset.caption":
    "Caption metadata and supporting annotations.",
  "designlab.showcase.component.text.emphasis.title": "Emphasis variants",
  "designlab.showcase.component.text.emphasis.primary":
    "Primary emphasis for key decisions.",
  "designlab.showcase.component.text.emphasis.secondary":
    "Secondary emphasis for supporting context.",
  "designlab.showcase.component.text.emphasis.muted":
    "Muted emphasis for quiet metadata.",
  "designlab.showcase.component.text.emphasis.success":
    "Success emphasis for completed outcomes.",
  "designlab.showcase.component.text.emphasis.danger":
    "Danger emphasis for blocked actions.",
  "designlab.showcase.component.text.clamp.title": "Clamp + truncate",
  "designlab.showcase.component.text.clamp.singleLine":
    "A single-line sentence that should truncate before it overruns the card width.",
  "designlab.showcase.component.text.clamp.multiLine":
    "A multi-line explanation that stays readable while the layout keeps a strict height and avoids pushing the surrounding surface.",
  "designlab.showcase.component.text.readability.title": "Readability",
  "designlab.showcase.component.text.readability.paragraph":
    "Readable copy should preserve rhythm across dense admin screens so reviews, approvals and release notes stay clear under pressure.",
  "designlab.showcase.component.text.readability.tabularNums":
    "Tabular numerals keep metrics aligned in audit summaries.",
  "designlab.showcase.component.textInput.live.primary.title":
    "Label / helper / counter",
  "designlab.showcase.component.textInput.live.primary.label": "Username",
  "designlab.showcase.component.textInput.live.primary.description":
    "Short name shown across the system.",
  "designlab.showcase.component.textInput.live.primary.hint":
    "Use up to 32 characters without spaces.",
  ...
  "designlab.showcase.component.textArea.live.authoring.title":
    "Auto resize / helper",
  "designlab.showcase.component.textArea.live.authoring.label": "Description",
  "designlab.showcase.component.textArea.live.authoring.description":
    "Shared text input for longer content fields.",
  "designlab.showcase.component.textArea.live.authoring.hint":
    "Use auto height for multi-line authoring input.",
  ...
  "designlab.showcase.component.textArea.live.stateMatrix.readonlyValue":
    "System logs cannot be edited by the user.",
  ...
  "designlab.showcase.component.checkbox.live.controlled.label":
    "Send post-release notification",
  "designlab.showcase.component.checkbox.live.controlled.description":
    "Notify stakeholders automatically when the flow is complete.",
  "designlab.showcase.component.checkbox.live.controlled.hint":
    "You can turn it off again if needed.",
  "designlab.showcase.component.checkbox.live.controlled.activeValue":
    "Active selection: {state}",
  "designlab.showcase.component.checkbox.live.controlled.stateOn": "On",
  "designlab.showcase.component.checkbox.live.controlled.stateOff": "Off",
  ...
  "designlab.showcase.component.checkbox.live.stateMatrix.indeterminateHint":
    "A subset of child options is selected.",
  ...
  "designlab.showcase.component.radio.live.controlled.design.description":
    "Finish visuals and documentation quality first.",
  "designlab.showcase.component.radio.live.controlled.ops.label": "Ops-led",
  "designlab.showcase.component.radio.live.controlled.ops.description":
    "Complete doctor and gate evidence first.",
  ...
  "designlab.showcase.component.radio.live.controlled.delivery.description":
    "Prioritize delivery artifacts after the feature lands.",
  ...
  "designlab.showcase.component.radio.live.stateMatrix.invalidError":
    "At least one rollout strategy must be selected.",
  ...
  "designlab.showcase.component.switch.live.controlled.label":
    "Enable live visibility",
  "designlab.showcase.component.switch.live.controlled.description":
    "Make the published screen visible to end users immediately.",
  "designlab.showcase.component.switch.live.controlled.hint":
    "You can turn it off again when needed.",
  "designlab.showcase.component.switch.live.controlled.activeStatus":
    "Current status: {state}",
  "designlab.showcase.component.switch.live.controlled.stateOn": "On",
  "designlab.showcase.component.switch.live.controlled.stateOff": "Off",
  ...
  "designlab.showcase.component.switch.live.stateMatrix.invalidError":
    "This transition requires additional approval.",
  "designlab.showcase.component.slider.live.controlled.title":
    "Controlled range",
  "designlab.showcase.component.slider.live.controlled.label": "Density",
  "designlab.showcase.component.slider.live.controlled.description":
    "Manage card and table spacing from one source.",
  "designlab.showcase.component.slider.live.controlled.hint":
    "Higher values produce a more spacious layout.",
  "designlab.showcase.component.slider.live.controlled.minLabel": "Compact",
  "designlab.showcase.component.slider.live.controlled.maxLabel": "Comfortable",
  ...
  "designlab.showcase.component.slider.live.stateMatrix.invalidError":
    "This change requires additional approval.",
  ...
  "designlab.showcase.component.datePicker.live.controlled.description":
    "Plan the day when the task will be completed.",
  "designlab.showcase.component.datePicker.live.controlled.hint":
    "Use calendar selection to create a shareable milestone.",
  ...
  "designlab.showcase.component.datePicker.live.stateMatrix.invalidError":
    "The date falls outside the current release window.",
  ...
  "designlab.showcase.component.timePicker.live.controlled.description":
    "Select the execution time inside the release window.",
  "designlab.showcase.component.timePicker.live.controlled.hint":
    "Plan in 15-minute increments.",
  ...
  "designlab.showcase.component.timePicker.live.stateMatrix.invalidError":
    "This time is outside the allowed deployment window.",
  ...
  "designlab.showcase.component.textInput.sections.profile.description":
    "Classic product form flow with label, description, helper and character counter.",
  ...
  "designlab.showcase.component.textInput.sections.profile.guideline":
    "For primary form fields, label, description and hint should appear together. Counters should open only when character pressure exists.",
  ...
  "designlab.showcase.component.textInput.sections.search.title":
    "Search / command bar input",
  "designlab.showcase.component.textInput.sections.search.description":
    "A faster, shorter and more action-oriented variant used in search and filter rows.",
  ...
  "designlab.showcase.component.textInput.sections.search.searchDescription":
    "Search for a record, company or user.",
  ...
  "designlab.showcase.component.textInput.sections.search.quickFilterLabel":
    "Quick filter",
  "designlab.showcase.component.textInput.sections.search.apply": "Apply",
  ...
  "designlab.showcase.component.textInput.sections.validation.description":
    "Validated, invalid and readonly field behavior with the same primitive.",
  ...
  "designlab.showcase.component.textInput.sections.density.title":
    "Density / sizing matrix",
  "designlab.showcase.component.textInput.sections.density.description":
    "Small, medium and large hit-area options with the same API.",
  ...
  "designlab.showcase.component.textInput.sections.density.panelSmall": "Small",
  "designlab.showcase.component.textInput.sections.density.panelMedium":
    "Medium",
  "designlab.showcase.component.textInput.sections.density.panelLarge": "Large",
  ...
  "designlab.showcase.component.textInput.sections.invite.title":
    "Inline action / invite flow",
  "designlab.showcase.component.textInput.sections.invite.description":
    "A short flow that shows the field and action in the same block.",
  ...
  "designlab.showcase.component.textInput.sections.invite.pending": "Pending",
  "designlab.showcase.component.textInput.sections.invite.send": "Send invite",
  ...
  "designlab.showcase.component.textInput.sections.access.title":
    "Policy / access controlled states",
  "designlab.showcase.component.textInput.sections.access.description":
    "Readonly, disabled and hidden policy modes of the same component.",
  ...
  "designlab.showcase.component.textInput.sections.access.readonlyHint":
    "Only the system can modify this field.",
  ...
  "designlab.showcase.component.textInput.sections.access.disabledHint":
    "Editing is closed after publish.",
  ...
  "designlab.showcase.component.textInput.sections.access.rule":
    "Hidden state should not leave empty space on the page; disabled and readonly must not look identical. One is passive, the other is a locked but informative state.",
  ...
  "designlab.showcase.component.textArea.sections.authoring.title":
    "Authoring / note field",
  "designlab.showcase.component.textArea.sections.authoring.description":
    "Primary authoring surface for longer descriptions.",
  ...
  "designlab.showcase.component.textArea.sections.authoring.guideline":
    "Auto resize feels more natural on authoring surfaces. Use controlled vertical resize in audit or fixed-layout areas.",
  ...
  "designlab.showcase.component.textArea.sections.review.description":
    "Readable review surface for decisions, objections or comments.",
  ...
  "designlab.showcase.component.textArea.sections.review.reviewerValue":
    "The policy text was updated; the legal team should complete the final review before publish.",
  ...
  "designlab.showcase.component.textArea.sections.review.auditValue":
    "2026-03-07 12:48 · system-bot -> release evidence file added.",
  ...
  "designlab.showcase.component.textArea.sections.validation.description":
    "Missing description, minimum content and user feedback.",
  ...
  "designlab.showcase.component.textArea.sections.layout.description":
    "Two layout examples of the same component for narrow side panels and wide content panels.",
  ...
  "designlab.showcase.component.textArea.sections.layout.primaryValue":
    "In this release, navigation components were reorganized, the forms wave was opened and frontend doctor evidence became mandatory.",
  ...
  "designlab.showcase.component.textArea.sections.recipes.description":
    "Which TextArea behavior should be selected in which context.",
  ...
  "designlab.showcase.component.textArea.sections.recipes.comment.note":
    "Use auto resize for comments and discussion flows.",
  "designlab.showcase.component.textArea.sections.recipes.audit.label": "Audit",
  ...
  "designlab.showcase.component.textArea.sections.recipes.audit.note":
    "System logs and immutable record surfaces.",
  ...
  "designlab.showcase.component.textArea.sections.recipes.policy.note":
    "Controlled resize for long legal text.",
  "designlab.showcase.component.checkbox.sections.single.eyebrow":
    "Alternative 01",
  "designlab.showcase.component.checkbox.sections.single.title":
    "Single consent",
  "designlab.showcase.component.checkbox.sections.single.description":
    "Single-line approval and notification field.",
  ...
  "designlab.showcase.component.checkbox.sections.single.rule":
    "Use a checkbox for single decision fields, and a stacked checkbox list for multiple but independent preferences.",
  "designlab.showcase.component.checkbox.sections.states.eyebrow":
    "Alternative 02",
  "designlab.showcase.component.checkbox.sections.states.title": "State matrix",
  "designlab.showcase.component.checkbox.sections.states.description":
    "Missing approval, partial selection, readonly and disabled behavior.",
  ...
  "designlab.showcase.component.radio.sections.choice.title":
    "Single-choice strategy",
  "designlab.showcase.component.radio.sections.choice.description":
    "A guided form surface where one decision is selected with a single option.",
  ...
  "designlab.showcase.component.radio.sections.choice.selected.note":
    "Controlled radio state is managed by the shell.",
  "designlab.showcase.component.radio.sections.states.eyebrow":
    "Alternative 02",
  "designlab.showcase.component.radio.sections.states.title": "State matrix",
  "designlab.showcase.component.radio.sections.states.description":
    "Invalid, readonly and disabled radio states.",
  "designlab.showcase.component.radio.sections.states.badge.invalid": "invalid",
  ...
  "designlab.showcase.component.radio.sections.states.badge.disabled":
    "disabled",
  "designlab.showcase.component.radio.sections.states.panelDefault": "Default",
  "designlab.showcase.component.radio.sections.states.panelInvalid": "Invalid",
  ...
  "designlab.showcase.component.switch.sections.toggle.description":
    "Controlled usage that changes visibility or rollout state with a single toggle.",
  ...
  "designlab.showcase.component.switch.sections.toggle.status.note":
    "The switch change is tracked directly through controlled state.",
  "designlab.showcase.component.switch.sections.states.eyebrow":
    "Alternative 02",
  "designlab.showcase.component.switch.sections.states.title": "State matrix",
  "designlab.showcase.component.switch.sections.states.description":
    "Readonly, disabled and policy-blocked switch behaviors.",
  ...
  "designlab.showcase.component.slider.sections.density.description":
    "Controlled numeric selection for surface density and layout tightness.",
  ...
  "designlab.showcase.component.slider.sections.density.currentValue.note":
    "The slider value is carried into preview and regression surfaces through controlled state.",
  "designlab.showcase.component.slider.sections.states.eyebrow":
    "Alternative 02",
  "designlab.showcase.component.slider.sections.states.title":
    "Readonly and policy states",
  "designlab.showcase.component.slider.sections.states.description":
    "Range input behavior for readonly and blocked-by-policy scenarios.",
  ...
  "designlab.showcase.component.datePicker.sections.milestone.description":
    "Calendar-based delivery date and rollout day selection.",
  ...
  "designlab.showcase.component.datePicker.sections.milestone.selected.note":
    "The DatePicker controlled value flows into release and planning workflows.",
  ...
  "designlab.showcase.component.datePicker.sections.states.title":
    "Readonly and validation states",
  "designlab.showcase.component.datePicker.sections.states.description":
    "A single shell contract for readonly and invalid date selection states.",
  ...
  "designlab.showcase.component.timePicker.sections.window.description":
    "Controls deployment, maintenance and approval window times in a governed way.",
  ...
  "designlab.showcase.component.timePicker.sections.window.selected.note":
    "The TimePicker controlled state feeds the rollout flow.",
  ...
  "designlab.showcase.component.timePicker.sections.states.description":
    "Readonly and release-window validation scenarios shown with the same shell language.",
  ...
  "designlab.showcase.component.upload.sections.evidence.title":
    "Evidence pack uploader",
  "designlab.showcase.component.upload.sections.evidence.description":
    "A controlled upload surface that gathers policy, release and audit evidence in one place.",
  "designlab.showcase.component.upload.sections.evidence.badge.files": "files",
  ...
  "designlab.showcase.component.upload.sections.evidence.controlled.description":
    "Collect release and approval evidence from a single place.",
  "designlab.showcase.component.upload.sections.evidence.controlled.hint":
    "PDF, XLSX and ZIP are supported.",
  ...
  "designlab.showcase.component.upload.sections.states.title":
    "Validation and access states",
  "designlab.showcase.component.upload.sections.states.description":
    "Readonly, disabled and policy-blocked upload behaviors shown in separate panels.",
  ...
  "designlab.showcase.component.upload.sections.states.panelDisabled":
    "Disabled",
  "designlab.showcase.component.upload.sections.states.panelInvalid": "Invalid",
  ...
  "designlab.showcase.component.upload.sections.states.invalidError":
    "At least one signed PDF must be uploaded.",
  ...
  "designlab.showcase.component.commandPalette.sections.launcher.title":
    "Global launcher / route switcher",
  "designlab.showcase.component.commandPalette.sections.launcher.description":
    "Primary command palette experience that navigates routes and operational actions in a single dialog.",
  ...
  "designlab.showcase.component.commandPalette.sections.launcher.paletteSubtitle":
    "Navigation, release review and AI-assisted actions live in the same palette.",
  ...
  "designlab.showcase.component.commandPalette.sections.launcher.selected.note":
    "Palette selection drives route or action state.",
  ...
  "designlab.showcase.component.commandPalette.sections.readonly.description":
    "Users with restricted access can see commands but cannot execute them; the same component preserves that distinction.",
  ...
  "designlab.showcase.component.commandPalette.sections.readonly.body":
    "In readonly mode, the user sees command titles, group information and shortcuts; no action is triggered.",
  ...
  "designlab.showcase.component.commandPalette.sections.scope.title":
    "Approval-scoped command set",
  "designlab.showcase.component.commandPalette.sections.scope.description":
    "AI and approval flows are grouped in the same palette with scope badges.",
  ...
  "designlab.showcase.component.commandPalette.sections.scope.chipApprovalQueue":
    "approval queue",
  "designlab.seed.contextMenuAction.empty": "No selection yet",
  "designlab.seed.commandPalette.group.navigate": "Navigate",
  "designlab.seed.commandPalette.group.governance": "Governance",
  "designlab.seed.commandPalette.group.aiAssist": "AI Assist",
  "designlab.seed.commandPalette.items.docs.title": "UI Library docs",
  "designlab.seed.commandPalette.items.docs.description":
    "Return to the component documentation page and live examples.",
  "designlab.seed.commandPalette.items.docs.badge": "Docs",
  "designlab.seed.commandPalette.items.review.title": "Release evidence review",
  "designlab.seed.commandPalette.items.review.description":
    "Review doctor and gate evidence from a single summary.",
  "designlab.seed.commandPalette.items.review.badge": "Review",
  "designlab.seed.commandPalette.items.aiQueue.title": "AI approval queue",
  "designlab.seed.commandPalette.items.aiQueue.description":
    "Open the AI recommendation queue waiting for human approval.",
  "designlab.seed.commandPalette.items.aiQueue.badge": "Human",
  "designlab.seed.commandPalette.items.applyRollout.title":
    "Apply safe rollout",
  "designlab.seed.commandPalette.items.applyRollout.description":
    "Apply the low-risk rollout recommendation in a controlled way.",
  ...
  "designlab.showcase.component.commandPalette.live.launcher.title":
    "Management command palette",
  "designlab.showcase.component.commandPalette.live.launcher.subtitle":
    "Gather navigation, AI suggestions and governance actions in a single palette.",
  "designlab.showcase.component.commandPalette.live.launcher.footer":
    "Doctor, gate and approval flows appear in the same palette.",
  ...
  "designlab.showcase.component.commandPalette.live.state.query.note":
    "The palette runs with controlled query state.",
  ...
  "designlab.showcase.component.commandPalette.live.state.selection.note":
    "The selected command triggers a route or AI action.",
  ...
  "designlab.showcase.component.commandPalette.live.state.details.evidence.value":
    "doctor + gate",
  "designlab.showcase.component.pageHeader.live.eyebrow": "Page Shell",
  "designlab.showcase.component.pageHeader.live.title": "Component Library",
  "designlab.showcase.component.pageHeader.live.description":
    "Combines catalog, release and quality information in a single page header shell.",
  "designlab.showcase.component.pageHeader.live.status": "Stable shell",
  "designlab.showcase.component.pageHeader.live.action.notes": "Release notes",
  "designlab.showcase.component.pageHeader.live.action.publish": "Publish",
  "designlab.showcase.component.pageHeader.live.aside":
    "Latest doctor evidence: PASS",
  "designlab.showcase.component.detailDrawer.live.open": "Open detail",
  "designlab.showcase.component.detailDrawer.live.title": "Record detail",
  ...
  "designlab.showcase.component.detailDrawer.live.sections.audit.content":
    "Updated 2026-03-06",
  "designlab.showcase.component.popover.live.title": "Policy guidance",
  "designlab.showcase.component.popover.live.open": "Open popover",
  "designlab.showcase.component.popover.live.description":
    "Use a popover when short but rich context is needed. This panel provides decision support without changing the route.",
  "designlab.showcase.component.popover.live.badge.policy": "Policy",
  "designlab.showcase.component.popover.live.badge.readonly": "Readonly",
  ...
  "designlab.showcase.component.contextMenu.live.trigger.items.approve.description":
    "Collect human approval and wave gate evidence together.",
  ...
  "designlab.showcase.component.contextMenu.live.trigger.items.review.description":
    "Produce readonly review and additional evidence requests.",
  ...
  "designlab.showcase.component.contextMenu.live.trigger.items.archive.description":
    "Move stale variants to the planned backlog area.",
  ...
  "designlab.showcase.component.contextMenu.live.surface.items.readonly.description":
    "The context menu is also constrained by a policy guard.",
  ...
  "designlab.showcase.component.contextMenu.live.surface.description":
    "The same contract works on right-click surfaces as well. Menus should stay short action lists, not navigation trees.",
  "designlab.showcase.component.tourCoachmarks.live.guided.panel":
    "Guided walkthrough",
  "designlab.showcase.component.tourCoachmarks.live.guided.open": "Start tour",
  ...
  "designlab.showcase.component.tourCoachmarks.live.guided.steps.scope.description":
    "Wave and registry contracts are clarified first so the user sees what is being published.",
  ...
  "designlab.showcase.component.tourCoachmarks.live.guided.steps.preview.description":
    "Preview, API and quality evidence are explained in the same walkthrough.",
  ...
  "designlab.showcase.component.tourCoachmarks.live.guided.steps.release.description":
    "The tour is not considered complete until doctor, gate and security guardrail evidence are finished.",
  ...
  "designlab.showcase.component.tourCoachmarks.live.readonly.steps.policy.description":
    "Readonly walkthroughs carry cause-and-effect context for critical areas in the same overlay.",
  ...
  "designlab.showcase.component.tourCoachmarks.live.readonly.steps.controls.description":
    "Release buttons should not remain visible until approval and security controls are completed.",
  ...
  "designlab.showcase.component.detailDrawer.sections.tabbed.description":
    "Presents detail, audit and rollout summary in the same slide-over with tabs.",
  ...
  "designlab.showcase.component.detailDrawer.sections.tabbed.guideline":
    "DetailDrawer is suitable for presenting detail, audit and summary content without breaking the route. Prefer drawers when content density exceeds a modal.",
  ...
  "designlab.showcase.component.detailDrawer.sections.readonly.description":
    "Collects evidence and summary blocks in a tabless but orderly review surface.",
  ...
  "designlab.showcase.component.detailDrawer.sections.readonly.card.body":
    "A detail drawer can also work as a single summary surface. It is especially effective for readonly evidence and snapshot reviews.",
  ...
  "designlab.showcase.component.detailDrawer.sections.readonly.rule":
    "If content becomes too long, use sections or tabs inside the drawer; if the review is short and passive, a tabless summary is enough.",
  ...
  "designlab.showcase.component.popover.sections.rich.description":
    "Shows contextual information in place when a tooltip is too short and a drawer is too heavy.",
  ...
  "designlab.showcase.component.popover.sections.rich.popoverTitle":
    "Policy note",
  "designlab.showcase.component.popover.sections.rich.open": "Open popover",
  "designlab.showcase.component.popover.sections.rich.body":
    "This area can only be edited while the publish window is open. Scope and risk are explained in a short panel.",
  ...
  "designlab.showcase.component.popover.sections.rich.guideline":
    "Use popovers for short but rich content. It is not a menu; it provides a helper panel, extra context or a small action cluster.",
  ...
  "designlab.showcase.component.popover.sections.readonly.title":
    "Readonly helper panel",
  "designlab.showcase.component.popover.sections.readonly.description":
    "Makes cause-and-effect information more visible than a tooltip in readonly and disabled flows.",
  ...
  "designlab.showcase.component.popover.sections.readonly.body":
    "A readonly popover should not open; in this case another surface should be chosen.",
  ...
  "designlab.showcase.component.popover.sections.readonly.rule":
    "If the user cannot act, the popover itself must follow the policy guard as well; consider a tooltip or inline message as an alternative.",
  ...
  "designlab.showcase.component.contextMenu.sections.trigger.description":
    "Shows short action lists together with policy and review context in the same overlay.",
  ...
  "designlab.showcase.component.contextMenu.sections.trigger.items.archive.description":
    "Move stale variants into the planned backlog area.",
  ...
  "designlab.showcase.component.contextMenu.sections.trigger.guideline":
    "A context menu is not a multi-level tree or a long explanation panel. Use it for short contextual actions; choose a popover or drawer if deeper information is needed.",
  ...
  "designlab.showcase.component.contextMenu.sections.surface.description":
    "Uses the same contract for right-click behavior on canvas or card surfaces.",
  ...
  "designlab.showcase.component.contextMenu.sections.surface.items.readonly.description":
    "Constrained by the policy guard.",
  ...
  "designlab.showcase.component.contextMenu.sections.surface.body":
    "Surface menus provide quick actions on rows, cards or canvas areas. They should not be used for navigation trees.",
  ...
  "designlab.showcase.component.contextMenu.sections.surface.rule":
    "If a right-click menu exists, the same actions must also have an accessible button-trigger alternative. Designs exclusive to mouse users are not acceptable.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.guided.description":
    "A guided surface that explains wave, preview and release evidence step by step.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.guided.steps.release.description":
    "The walkthrough is not complete until doctor, gate and security guardrail evidence are finished.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.guided.guideline":
    "Tour and coachmarks are useful not only for onboarding but also for critical approval, release and policy flows that need step-by-step context.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.readonly.description":
    "Carries readonly policy reasons and control points in a calm narrative.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.readonly.steps.policy.description":
    "Readonly walkthrough carries cause-and-effect information for critical areas in the same overlay.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.readonly.steps.controls.description":
    "Release buttons should not remain visible until approval and security checks are completed.",
  ...
  "designlab.showcase.component.tourCoachmarks.sections.readonly.rule":
    "If the coachmark surface needs very long content, it should become a docs page or panel structure. Keep tours short, guiding and task-focused.",
  ...
  "designlab.showcase.component.pageHeader.sections.release.title":
    "Release and docs header",
  "designlab.showcase.component.pageHeader.sections.release.description":
    "Collects eyebrow, title, status, meta and quick action blocks on a single top surface.",
  ...
  "designlab.showcase.component.pageHeader.sections.release.badge.hero": "hero",
  ...
  "designlab.showcase.component.pageHeader.sections.release.header.description":
    "The release and docs surface for the new page-level block family is built with the same header primitive.",
  ...
  "designlab.showcase.component.pageHeader.sections.release.guideline":
    "`PageHeader` gathers the route-level hero area in a single primitive. It removes the need to build page-specific headers for meta chips, status badges and aside metrics.",
  ...
  "designlab.showcase.component.pageHeader.sections.compact.description":
    "Compact header usage for denser detail pages.",
  ...
  "designlab.showcase.component.pageHeader.sections.compact.badge.detail":
    "detail",
  "designlab.showcase.component.pageHeader.sections.compact.badge.meta": "meta",
  ...
  "designlab.showcase.component.pageHeader.sections.compact.header.description":
    "A shorter header surface for component detail.",
  ...
  "designlab.showcase.component.pageHeader.sections.compact.contract.aside.value":
    "metric or helper",
  "designlab.showcase.component.pageLayout.live.title": "User Directory",
  "designlab.showcase.component.pageLayout.live.description":
    "Route-level layout composition example",
  "designlab.showcase.component.pageLayout.live.breadcrumb.admin": "Admin",
  "designlab.showcase.component.pageLayout.live.breadcrumb.users": "Users",
  "designlab.showcase.component.pageLayout.live.action": "New record",
  "designlab.showcase.component.pageLayout.live.filterSlot": "Filter slot",
  "designlab.showcase.component.pageLayout.live.detail": "Detail panel",
  "designlab.showcase.component.pageLayout.live.content": "Main content",
  "designlab.showcase.component.filterBar.live.search": "Search",
  "designlab.showcase.component.filterBar.live.status": "Status",
  "designlab.showcase.component.reportFilterPanel.live.dateRange": "Date range",
  "designlab.showcase.component.reportFilterPanel.live.owner": "Owner",
  ...
  "designlab.showcase.component.pageLayout.sections.directory.description":
    "Collects breadcrumb, page header, filter shell and detail aside inside the same page-level contract.",
  ...
  "designlab.showcase.component.pageLayout.sections.directory.shell.title":
    "UI governance catalog",
  "designlab.showcase.component.pageLayout.sections.directory.shell.description":
    "Page shell, header and filter behavior are reused through a single layout contract.",
  ...
  "designlab.showcase.component.pageLayout.sections.directory.detail.description":
    "The ratio between layout, detail rail and body stays within the same shell.",
  ...
  "designlab.showcase.component.pageLayout.sections.directory.summary.description":
    "Highlights the key metrics together with the page shell.",
  ...
  "designlab.showcase.component.pageLayout.sections.directory.contract.description":
    "The same layout is reusable across drawer and detail pages.",
  ...
  "designlab.showcase.component.pageLayout.sections.directory.contractNote":
    "`PageLayout` combines breadcrumb, action rail, filter shell and detail aside at route level and removes page-specific shell duplication.",
  ...
  "designlab.showcase.component.pageLayout.sections.detail.description":
    "The same layout can be used with a denser aside and footer on detail-focused pages.",
  ...
  "designlab.showcase.component.pageLayout.sections.detail.shell.description":
    "Readonly review and approve/reject actions stay in the same page shell.",
  ...
  "designlab.showcase.component.pageLayout.sections.detail.footer":
    "Footer rail stays inside the same shell contract.",
  ...
  "designlab.showcase.component.pageLayout.sections.detail.entity.subtitle":
    "Page-level reusable shell rollout summary.",
  ...
  "designlab.showcase.component.pageLayout.sections.detail.usageNote":
    "The same layout works for both directory and detail/review screens; only the content and callbacks change.",
  ...
  "designlab.showcase.component.filterBar.sections.toolbar.description":
    "Collects search, filter and save-view actions on a shared toolbar surface.",
  ...
  "designlab.showcase.component.filterBar.sections.toolbar.metric.note":
    "Reset/save-view actions are managed through the same shell.",
  ...
  "designlab.showcase.component.filterBar.sections.readonly.description":
    "Readonly or policy-locked toolbar states remain inside the same component.",
  ...
  "designlab.showcase.component.filterBar.sections.readonly.guideline":
    "Filter shell does not clone page-specific toolbars; only the fields and callbacks are provided.",
  ...
  "designlab.showcase.component.reportFilterPanel.sections.submit.description":
    "Collects multi-field report filters and actions under one panel contract.",
  ...
  "designlab.showcase.component.reportFilterPanel.sections.submit.metric.note":
    "Submit and reset behavior are managed through the same panel.",
  ...
  "designlab.showcase.component.reportFilterPanel.sections.readonly.description":
    "Readonly and policy-locked scenarios keep the information visible while submit remains disabled.",
  ...
  "designlab.showcase.component.recommendationCard.sections.rollout.title":
    "Rollout recommendation card",
  "designlab.showcase.component.recommendationCard.sections.rollout.description":
    "Shows an AI-supported rollout recommendation together with rationale, citations and confidence.",
  ...
  "designlab.showcase.component.recommendationCard.sections.rollout.card.title":
    "Forms wave rollout ready",
  "designlab.showcase.component.recommendationCard.sections.rollout.card.summary":
    "Gate and doctor results show that the forms wave can be published in a controlled way.",
  ...
  "designlab.showcase.component.recommendationCard.sections.rollout.summary.note":
    "Card state is kept in sync with doctor and the audit timeline.",
  ...
  "designlab.showcase.component.recommendationCard.sections.readonly.title":
    "Readonly governance advisory",
  "designlab.showcase.component.recommendationCard.sections.readonly.description":
    "Action buttons on a review-oriented card are locked according to access mode.",
  ...
  "designlab.showcase.component.recommendationCard.sections.readonly.card.summary":
    "This recommendation is shown as readonly; the approval flow continues on a separate surface.",
  ...
  "designlab.showcase.component.recommendationCard.sections.readonly.reasoning":
    "A recommendation card does not leave the recommendation text alone; rationale, citations and confidence are read together on the same surface.",
  ...
  "designlab.showcase.component.recommendationCard.sections.queue.description":
    "Helps show multiple recommendations in a more compact footprint inside the approval queue.",
  ...
  "designlab.showcase.component.recommendationCard.sections.queue.itemSummary":
    "Show the next recommendation title with compact density.",
  ...
  "designlab.showcase.component.confidenceBadge.sections.matrix.description":
    "Shows low -> very-high levels together with score and source count.",
  ...
  "designlab.showcase.component.confidenceBadge.sections.matrix.guidance":
    "Confidence badge is an interpretation aid; confidence, citations and the need for human review should be read together.",
  ...
  "designlab.showcase.component.confidenceBadge.sections.compact.description":
    "Shows the same badge more compactly in dense lists and action header flows.",
  ...
  "designlab.showcase.component.confidenceBadge.sections.governed.title":
    "Access and transparency states",
  "designlab.showcase.component.confidenceBadge.sections.governed.description":
    "Readonly and controlled transparency states are shown under the same contract.",
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.interactive.description":
    "AI advice, evidence list and human approval actions come together in a single contract.",
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.interactive.card.summary":
    "When doctor and security evidence are PASS, the final human decision comes from this block.",
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.interactive.summary.note":
    "The state is read together with the audit timeline.",
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.readonly.description":
    "The same component is used in readonly mode inside the approval queue.",
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.readonly.card.summary":
    "For users who wait for human approval but do not have action authority.",
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.readonly.governanceNote":
    "The same primitive is used for both the approval flow and the review queue; the difference is defined by access level.",
  "designlab.seed.prompt.subject": "Quarterly ethics review",
  ...
  "designlab.seed.formField.textInput": "Nova user",
  "designlab.seed.formField.searchInput": "Audit plan",
  "designlab.seed.formField.textArea":
    "The description field should complete the form experience with inline help, error handling, and character count.",
  "designlab.seed.formField.comment":
    "This field should support comments, notes, and descriptions with automatic height.",
  "designlab.seed.approvalStep.doctor.label": "Doctor evidence clean",
  "designlab.seed.approvalStep.doctor.helper":
    "Browser doctor and pageerror evidence must be PASS.",
  "designlab.seed.approvalStep.doctor.owner": "Frontend QA",
  "designlab.seed.approvalStep.citations.label": "Citation transparency",
  "designlab.seed.approvalStep.citations.helper":
    "Source and excerpt panels must be attached to the decision.",
  "designlab.seed.approvalStep.citations.owner": "UX / Governance",
  "designlab.seed.approvalStep.human.label": "Human approval",
  "designlab.seed.approvalStep.human.helper":
    "The final publish decision must pass human approval.",
  "designlab.seed.approvalStep.human.owner": "Release Board",
  "designlab.seed.citation.policy.title": "Policy §4.2 Human approval",
  "designlab.seed.citation.policy.excerpt":
    "If an AI suggestion produces decision impact, human approval is mandatory before the final action.",
  "designlab.seed.citation.policy.badge": "critical",
  "designlab.seed.citation.ux.title": "UX Catalog: confidence transparency",
  "designlab.seed.citation.ux.excerpt":
    "Confidence, rationale and source transparency should be read together in the same experience surface.",
  "designlab.seed.citation.ux.badge": "ux",
  "designlab.seed.citation.doctor.title": "Doctor evidence: ui-library",
  "designlab.seed.citation.doctor.excerpt":
    "doctor:frontend ui-library preset returned PASS; no pageerror or console error was found.",
  "designlab.seed.citation.doctor.badge": "pass",
  "designlab.seed.audit.draft.title": "AI recommendation drafted",
  "designlab.seed.audit.draft.summary":
    "A publish-ready summary was generated for the forms wave and confidence was calculated.",
  "designlab.seed.audit.draft.badge": "wave-6",
  "designlab.seed.audit.review.title": "Governance review requested",
  "designlab.seed.audit.review.summary":
    "A second review was requested together with the citation panel and approval checkpoint.",
  "designlab.seed.audit.review.badge": "review",
  "designlab.seed.audit.release.title": "Release note staged",
  "designlab.seed.audit.release.summary":
    "The canary contract and release notes were marked with draft status.",
  "designlab.seed.audit.release.badge": "observed",
  "designlab.state.recommendation.pending": "Pending",
  "designlab.state.recommendation.applied": "Applied",
  "designlab.state.recommendation.review": "In review",
  "designlab.state.approval.pending": "Pending",
  "designlab.state.approval.approved": "Approved",
  "designlab.state.approval.rejected": "Rejected",
  "designlab.state.promptScope.general": "General",
  "designlab.state.promptScope.approval": "Approval",
  "designlab.state.promptScope.policy": "Policy",
  "designlab.state.promptScope.release": "Release",
  "designlab.state.promptTone.neutral": "Neutral",
  "designlab.state.promptTone.strict": "Strict",
  "designlab.state.promptTone.exploratory": "Exploratory",
  "designlab.state.auditActor.ai": "AI",
  "designlab.state.auditActor.human": "Human",
  "designlab.state.auditActor.system": "System",
  "designlab.state.auditStatus.drafted": "Drafted",
  "designlab.state.auditStatus.approved": "Approved",
  "designlab.state.auditStatus.observed": "Observed",
  "designlab.showcase.component.recommendationCard.live.interactive.panel":
    "Interactive governance recommendation",
  "designlab.showcase.component.recommendationCard.live.interactive.card.title":
    "Security remediation wave now",
  "designlab.showcase.component.recommendationCard.live.interactive.card.summary":
    "Dependency findings are closed. You can publish the UI library forms wave in a controlled manner.",
  ...
  "designlab.showcase.component.recommendationCard.live.interactive.rationale.doctor":
    "doctor:frontend evidence is green",
  ...
  "designlab.showcase.component.recommendationCard.live.readonly.card.summary":
    "This recommendation is not applied directly. It appears together with the citation panel and audit timeline.",
  ...
  "designlab.showcase.component.confidenceBadge.live.compact.note":
    "A confidence badge does not claim certainty on its own; score, source count and review requirement should be read together.",
  ...
  "designlab.showcase.component.approvalCheckpoint.live.interactive.card.title":
    "Forms wave publish checkpoint",
  "designlab.showcase.component.approvalCheckpoint.live.interactive.card.summary":
    "Before the AI helper wave is published, doctor, citations and human approval are shown on the same surface.",
  ...
  "designlab.showcase.component.approvalCheckpoint.live.readonly.card.title":
    "Readonly approval evidence",
  "designlab.showcase.component.approvalCheckpoint.live.readonly.card.summary":
    "This variant is readonly in the review flow; it does not trigger actions.",
  ...
  "designlab.showcase.component.citationPanel.sections.sourceTransparency.description":
    "Policy, UX and doctor evidence are read in one panel and the selected source is highlighted.",
  ...
  "designlab.showcase.component.citationPanel.sections.readonly.description":
    "The source panel does not provide actions but preserves quote and locator details.",
  ...
  "designlab.showcase.component.citationPanel.sections.readonly.usageNote":
    "The citation panel is reused as the same primitive in recommendation and approval surfaces.",
  ...
  "designlab.showcase.component.aiActionAuditTimeline.sections.interactive.description":
    "AI actions, human reviews and system events are read through one timeline primitive.",
  ...
  "designlab.showcase.component.aiActionAuditTimeline.sections.readonly.description":
    "In readonly mode the timeline is used as audit evidence without selection.",
  ...
  "designlab.showcase.component.aiActionAuditTimeline.sections.readonly.auditNote":
    "This block can be reused with the same behavior across approval, recommendation and release pages.",
  ...
  "designlab.showcase.component.promptComposer.live.controlled.footerNote":
    "If prompt output will enter the release note, it should be combined with human approval.",
  ...
  "designlab.showcase.component.promptComposer.live.summary.scope.note":
    "Execution boundary",
  "designlab.showcase.component.promptComposer.live.summary.tone.label": "Tone",
  ...
  "designlab.showcase.component.promptComposer.sections.controlled.description":
    "Prompt subject, body, scope and tone are controlled through one composer primitive.",
  ...
  "designlab.showcase.component.promptComposer.sections.readonly.description":
    "The draft prompt text is reviewed with the same component but cannot be changed.",
  ...
  "designlab.showcase.component.promptComposer.sections.readonly.contractNote":
    "Prompt composer makes scope and tone guardrails visible instead of a free-form textarea.",
  "designlab.seed.dropdownAction.empty": "No selection yet",
  "designlab.seed.reportStatus.idle": "Waiting for filter",
  "designlab.seed.reportStatus.applied": "Filter applied",
  "designlab.seed.reportStatus.reset": "Filter reset",
  "designlab.seed.pageHeader.meta.releaseWindow": "Release Window · {date}",
  "designlab.seed.pageHeader.meta.owner": "Owner · Platform UI",
  "designlab.seed.pageHeader.meta.coverage": "Doctor coverage · PASS",
  "designlab.seed.summaryStrip.published.label": "Published",
  "designlab.seed.summaryStrip.published.note":
    "Real exported block and component set.",
  "designlab.seed.summaryStrip.published.trend": "+4 this week",
  "designlab.seed.summaryStrip.planned.label": "Planned",
  "designlab.seed.summaryStrip.planned.note":
    "Remaining productization backlog on the roadmap.",
  ...
  "designlab.seed.summaryStrip.doctor.note":
    "UI Library browser diagnostics are green.",
  "designlab.seed.summaryStrip.doctor.trend": "ui-library",
  "designlab.seed.summaryStrip.gate.label": "Wave Gate",
  "designlab.seed.summaryStrip.gate.note":
    "The full release gate chain passed.",
  "designlab.seed.summaryStrip.gate.trend": "latest",
  "designlab.seed.entitySummary.domain.label": "Domain",
  "designlab.seed.entitySummary.domain.value": "UI Platform",
  "designlab.seed.entitySummary.status.label": "Status",
  "designlab.seed.entitySummary.status.value": "Active",
  "designlab.seed.entitySummary.owner.label": "Owner",
  "designlab.seed.entitySummary.owner.value": "Platform Team",
  "designlab.seed.entitySummary.lastRelease.label": "Last Release",
  "designlab.seed.gridRows.record": "Record {index}",
  "designlab.seed.gridRows.status.active": "Active",
  "designlab.seed.gridRows.status.pending": "Pending",
  "designlab.seed.gridRows.status.disabled": "Disabled",
  "designlab.seed.serverGridRows.companies.name": "Companies",
  "designlab.seed.serverGridRows.users.name": "Users",
  "designlab.seed.serverGridRows.permissions.name": "Permissions",
  "designlab.seed.serverGridRows.variants.name": "Variants",
  "designlab.showcase.component.empty.catalogGroup":
    "There are no registered items in this catalog group yet.",
  "designlab.showcase.component.inspectorPreview.title": "Inspector preview",
  "designlab.showcase.component.inspectorPreview.description":
    "This export is tracked at behavior and contract level instead of a live UI surface.",
  "designlab.showcase.component.inspectorPreview.registryNote": "Registry note",
  "designlab.showcase.component.summaryStrip.live.title": "Release summary",
  "designlab.showcase.component.summaryStrip.live.description":
    "Delivers top-of-page KPI and status context through a reusable summary strip.",
  ...
  "designlab.showcase.component.summaryStrip.sections.releaseMetrics.title":
    "Release metrics strip",
  "designlab.showcase.component.summaryStrip.sections.releaseMetrics.description":
    "Presents the top metrics surface through a card-like but shared summary strip contract.",
  ...
  "designlab.showcase.component.summaryStrip.sections.releaseMetrics.stripDescription":
    "Export, doctor and wave gate snapshot in one strip.",
  ...
  "designlab.showcase.component.summaryStrip.sections.releaseMetrics.guideline":
    "A summary strip is not a dashboard KPI band; it carries short decision-supporting metrics under the page header.",
  ...
  "designlab.showcase.component.summaryStrip.sections.compactOwnership.description":
    "Two-column or three-column summary usage for narrower pages.",
  ...
  "designlab.showcase.component.entitySummaryBlock.sections.primary.description":
    "Collects entity-level summary, badge, avatar and detail descriptions in one block.",
  ...
  "designlab.showcase.component.entitySummaryBlock.sections.primary.card.subtitle":
    "Page block family owner and release summary",
  ...
  "designlab.showcase.component.entitySummaryBlock.sections.primary.whyUse":
    "`EntitySummaryBlock` provides a directly readable summary surface instead of a detail drawer or entity header.",
  ...
  "designlab.showcase.component.entitySummaryBlock.sections.withAvatar.title":
    "Avatar and governance metadata",
  "designlab.showcase.component.entitySummaryBlock.sections.withAvatar.description":
    "Carries the avatar, badge and descriptions combination with a more governance-focused presentation.",
  ...
  "designlab.showcase.component.entitySummaryBlock.sections.withAvatar.contract.details.value":
    "Descriptions grid",
  "designlab.showcase.component.agGridServer.shared.columns.source": "Source",
  "designlab.showcase.component.agGridServer.shared.columns.owner": "Owner",
  ...
  "designlab.showcase.component.agGridServer.sections.ownershipList.description":
    "AgGridServer presents gateway-fed owner/status lists with a server-side datasource contract.",
  ...
  "designlab.showcase.component.agGridServer.sections.ownershipList.metrics.datasource.note":
    "The grid fetches data through the getData contract.",
  ...
  "designlab.showcase.component.agGridServer.sections.ownershipList.metrics.surface.note":
    "Substrate component; the performance contract is mandatory.",
  ...
  "designlab.showcase.component.agGridServer.sections.loadingContract.description":
    "Datasource, loading and empty behavior stay inside the same primitive; no screen-level duplicate code is needed.",
  ...
  "designlab.showcase.component.agGridServer.sections.loadingContract.guidance":
    "`AgGridServer` centralizes server-side pagination and datasource binding in one place. This lets ownership lists, audit query results and entity registries share the same behavior contract.",
  ...
  "designlab.showcase.component.entityGridTemplate.sections.clientRegistry.description":
    "Collects toolbar, variant and pagination behavior on one entity template surface.",
  ...
  "designlab.showcase.component.entityGridTemplate.sections.clientRegistry.valueNote":
    "`EntityGridTemplate` combines toolbar, variant selection, pagination and theme axes in one substrate component. Client-side list screens do not need a separate shell implementation.",
  ...
  "designlab.showcase.component.entityGridTemplate.sections.serverMode.title":
    "Server-side toolbar and datasource mode",
  "designlab.showcase.component.entityGridTemplate.sections.serverMode.description":
    "The same template preserves datasource and toolbar behavior while running in server mode.",
  ...
  "designlab.showcase.component.dropdown.live.trigger": "Action menu",
  "designlab.showcase.component.dropdown.live.item.publish": "Publish",
  ...
  "designlab.showcase.component.dropdown.live.selection": "Selection: {value}",
  "designlab.showcase.component.tooltip.live.tooltipText": "Tooltip example",
  "designlab.showcase.component.tooltip.live.button": "Hover / Focus",
  "designlab.showcase.component.modal.live.open": "Open modal",
  "designlab.showcase.component.modal.live.title": "UI Kit Demo Modal",
  "designlab.showcase.component.modal.live.cancel": "Cancel",
  "designlab.showcase.component.modal.live.save": "Save",
  "designlab.showcase.component.modal.live.description":
    "Dialog preview bound to the token chain.",
  "designlab.showcase.component.formDrawer.live.open": "Open drawer",
  "designlab.showcase.component.formDrawer.live.title": "New record",
  ...
  "designlab.showcase.component.modal.sections.confirm.description":
    "Collects decision, secondary explanation and footer action language on one overlay shell for high-risk actions.",
  ...
  "designlab.showcase.component.modal.sections.confirm.open": "Open modal",
  ...
  "designlab.showcase.component.modal.sections.confirm.card.title":
    "Rollout approval required",
  "designlab.showcase.component.modal.sections.confirm.card.cancel": "Cancel",
  "designlab.showcase.component.modal.sections.confirm.card.confirm": "Confirm",
  "designlab.showcase.component.modal.sections.confirm.card.body":
    "This step triggers the release pipeline. Risk, scope and rollback impact should be visible to the user inside the same dialog.",
  ...
  "designlab.showcase.component.modal.sections.confirm.guideline":
    "A modal should be used for decisions, interruptions, approvals and form-focused short tasks, not for small inline help. Overlay click and escape behavior are managed according to task risk.",
  "designlab.showcase.component.modal.sections.readonly.eyebrow":
    "Alternative 02",
  "designlab.showcase.component.modal.sections.readonly.title":
    "Readonly / audit review dialog",
  "designlab.showcase.component.modal.sections.readonly.description":
    "A calmer modal variant for locked content, readonly review and evidence display.",
  ...
  "designlab.showcase.component.modal.sections.readonly.card.body":
    "Readonly text, extra information and a single dismiss action are shown in the dialog. When no user input is expected, the dialog language should stay calmer and lower-tension.",
  ...
  "designlab.showcase.component.modal.sections.readonly.rule":
    "The same modal primitive can carry both destructive and readonly review flows; the difference is created through copy tone and the number of footer actions.",
  ...
  "designlab.showcase.component.dropdown.sections.action.description":
    "Primary usage pattern for row-level quick actions and overflow menu behavior.",
  ...
  "designlab.showcase.component.dropdown.sections.action.guideline":
    "A dropdown is not a navigation tree. It is used for short action lists, row-level operations and contextual accelerators.",
  ...
  "designlab.showcase.component.dropdown.sections.density.description":
    "Uses the same primitive to manage view density and small settings menus.",
  ...
  "designlab.showcase.component.dropdown.sections.density.policyNote":
    "Dropdown content should stay short. For long, multi-level or explanation-heavy content, prefer popover or drawer.",
  "designlab.showcase.component.tooltip.sections.inline.eyebrow":
    "Alternative 01",
  "designlab.showcase.component.tooltip.sections.inline.title":
    "Inline hint / affordance",
  "designlab.showcase.component.tooltip.sections.inline.description":
    "Makes short helper explanations visible on focus and hover in narrow space.",
  "designlab.showcase.component.tooltip.sections.inline.badge.hint": "hint",
  "designlab.showcase.component.tooltip.sections.inline.badge.beta": "beta",
  "designlab.showcase.component.tooltip.sections.inline.badge.inline": "inline",
  ...
  "designlab.showcase.component.tooltip.sections.inline.tooltipExample":
    "Tooltip example",
  "designlab.showcase.component.tooltip.sections.inline.button":
    "Hover / Focus",
  "designlab.showcase.component.tooltip.sections.inline.tooltipInfo":
    "A short help text only adds extra context.",
  ...
  "designlab.showcase.component.tooltip.sections.inline.guideline":
    "A tooltip should not carry critical validation or long educational content. It is suitable for short help, affordance explanation and icon labeling.",
  "designlab.showcase.component.tooltip.sections.policy.eyebrow":
    "Alternative 02",
  "designlab.showcase.component.tooltip.sections.policy.title":
    "Policy / readonly guidance",
  "designlab.showcase.component.tooltip.sections.policy.description":
    "Shows cause-effect information in readonly or controlled surfaces without overwhelming the user.",
  "designlab.showcase.component.tooltip.sections.policy.badge.policy": "policy",
  ...
  "designlab.showcase.component.tooltip.sections.policy.tooltipText":
    "This field becomes readonly outside the publish window.",
  ...
  "designlab.showcase.component.tooltip.sections.policy.rule":
    "Content that should stop the user or force a decision should move to dialog, inline error or a panel surface instead of a tooltip.",
  ...
  "designlab.showcase.component.formDrawer.sections.create.description":
    "Carries short data entry into a side panel without losing page context.",
  ...
  "designlab.showcase.component.formDrawer.sections.create.guideline":
    "FormDrawer should be used for longer but still task-focused form flows instead of a modal. Data entry happens without route change and the main screen context is preserved.",
  ...
  "designlab.showcase.component.formDrawer.sections.readonly.title":
    "Readonly / policy constrained form drawer",
  "designlab.showcase.component.formDrawer.sections.readonly.description":
    "Keeps review and context alive while disabling the save action.",
  ...
  "designlab.showcase.component.formDrawer.sections.readonly.card.note":
    "The save action is disabled due to policy.",
  ...
  "designlab.showcase.component.formDrawer.sections.readonly.rule":
    "If only review is allowed because of policy, the drawer may stay open; submit closes while close action and context visibility remain available.",
  "designlab.showcase.component.tableSimple.shared.columns.policy": "Policy",
  "designlab.showcase.component.tableSimple.shared.columns.owner": "Owner",
  ...
  "designlab.showcase.component.tableSimple.live.policyStatus.description":
    "Task-focused lightweight table view.",
  ...
  "designlab.showcase.component.tableSimple.live.rows.ethics.owner":
    "Compliance",
  "designlab.showcase.component.tableSimple.live.rows.ethics.status": "Active",
  ...
  "designlab.showcase.component.tableSimple.live.rows.gifts.status": "Draft",
  ...
  "designlab.showcase.component.tableSimple.sections.policyList.title":
    "Policy / owner / status table",
  "designlab.showcase.component.tableSimple.sections.policyList.description":
    "Shows task-critical policy lists with a light, fast and readable table shell.",
  ...
  "designlab.showcase.component.tableSimple.sections.policyList.tableDescription":
    "Owner and status fields share a single table surface.",
  ...
  "designlab.showcase.component.tableSimple.sections.policyList.guidance":
    "`TableSimple` gives task lists a fast render, loading and empty-state contract without requiring heavy grid infrastructure.",
  ...
  "designlab.showcase.component.tableSimple.sections.loadingEmpty.description":
    "The same primitive handles loading skeletons and empty table behavior without local copies.",
  ...
  "designlab.showcase.component.descriptions.live.rolloutSummary.description":
    "Rollout owner, scope and review snapshot in one block.",
  ...
  "designlab.showcase.component.descriptions.live.rolloutSummary.items.owner.helper":
    "Team responsible for canary and rollout decisions.",
  ...
  "designlab.showcase.component.descriptions.live.rolloutSummary.items.review.helper":
    "Aligned with the change approval snapshot.",
  ...
  "designlab.showcase.component.descriptions.live.riskApproval.items.approval.helper":
    "Security sign-off is still pending.",
  ...
  "designlab.showcase.component.descriptions.sections.rolloutSummary.title":
    "Rollout / owner / scope summary",
  "designlab.showcase.component.descriptions.sections.rolloutSummary.description":
    "Collects owner, scope, review and status into a quickly readable key-value surface.",
  ...
  "designlab.showcase.component.descriptions.sections.rolloutSummary.interpretation":
    "`Descriptions` standardizes repeated label-value groups across drawers, detail panels and approval surfaces.",
  ...
  "designlab.showcase.component.descriptions.sections.compliancePanel.title":
    "Risk and approval panels",
  "designlab.showcase.component.descriptions.sections.compliancePanel.description":
    "Carries risk, approval and control snapshots with tone-aware information cards.",
  ...
  "designlab.showcase.component.descriptions.sections.compliancePanel.ownership.items.signoff.value":
    "Ready",
  "designlab.showcase.component.list.live.inbox.panel": "Operational inbox",
  "designlab.showcase.component.list.live.inbox.title": "Release work queue",
  "designlab.showcase.component.list.live.inbox.description":
    "Priority rollout and evidence tasks are tracked on the same surface.",
  "designlab.showcase.component.list.live.compact.panel": "Compact selectable",
  "designlab.showcase.component.list.live.compact.title": "Compact review",
  ...
  "designlab.showcase.component.list.live.queue.items.triage.description":
    "The publish window does not open until security and rollout evidence are complete.",
  "designlab.showcase.component.list.live.queue.items.triage.badge": "Blocked",
  "designlab.showcase.component.list.live.queue.items.doctor.title":
    "Frontend doctor summary",
  "designlab.showcase.component.list.live.queue.items.doctor.description":
    "UI Library, shell-public and auth route presets are collected in one report.",
  ...
  "designlab.showcase.component.list.live.queue.items.residual.description":
    "Prepare the update plan before the Jackson residual review date arrives.",
  ...
  "designlab.showcase.component.list.sections.operationalInbox.title":
    "Operational inbox / task list",
  "designlab.showcase.component.list.sections.operationalInbox.description":
    "Combines priority, metadata and badges on one list surface.",
  ...
  "designlab.showcase.component.list.sections.operationalInbox.listTitle":
    "Deployment work queue",
  "designlab.showcase.component.list.sections.operationalInbox.listDescription":
    "Security, doctor and rollout evidence are readable on one surface.",
  ...
  "designlab.showcase.component.list.sections.operationalInbox.why":
    "`List` carries selection, badge and metadata together in lightweight but stateful task flows without opening a table.",
  ...
  "designlab.showcase.component.list.sections.priorityReview.title":
    "Priority / review state matrix",
  "designlab.showcase.component.list.sections.priorityReview.description":
    "Makes compact density, blocked items and tone differences visible.",
  ...
  "designlab.showcase.component.jsonViewer.live.releasePayload.description":
    "Makes gate and doctor evidence readable without a debug screen.",
  ...
  "designlab.showcase.component.jsonViewer.live.policySnapshot.description":
    "Readonly operational contract surface.",
  ...
  "designlab.showcase.component.jsonViewer.sections.releasePayload.description":
    "Presents the wave gate and doctor summary as a readable layered JSON tree.",
  ...
  "designlab.showcase.component.jsonViewer.sections.releasePayload.cardDescription":
    "Gate and doctor evidence are tracked in the same payload.",
  ...
  "designlab.showcase.component.jsonViewer.sections.releasePayload.usage":
    "`JsonViewer` makes contract, config and evidence payloads readable to end users without feeling like a debug panel.",
  ...
  "designlab.showcase.component.jsonViewer.sections.policyConfig.description":
    "Compact rendering for narrower, readonly configuration snapshots.",
  ...
  "designlab.showcase.component.tree.live.hierarchy.description":
    "Reads gate and policy ownership in a single hierarchy.",
  "designlab.showcase.component.tree.live.readonly.panel": "Readonly review",
  "designlab.showcase.component.tree.live.readonly.title": "Readonly review",
  "designlab.showcase.component.tree.live.release.label":
    "Release control plane",
  "designlab.showcase.component.tree.live.release.description":
    "Collects gate, doctor and security evidence in one hierarchy.",
  "designlab.showcase.component.tree.live.release.meta": "root",
  "designlab.showcase.component.tree.live.release.badge": "Stable",
  "designlab.showcase.component.tree.live.doctor.label": "Doctor evidence",
  "designlab.showcase.component.tree.live.doctor.description":
    "Frontend doctor preset outputs.",
  ...
  "designlab.showcase.component.tree.live.doctorUiLibrary.description":
    "Console/pageerror and click-walk results are clean.",
  "designlab.showcase.component.tree.live.doctorUiLibrary.meta": "5 steps",
  "designlab.showcase.component.tree.live.doctorShell.label":
    "Shell public preset",
  "designlab.showcase.component.tree.live.doctorShell.description":
    "Login and public route chain PASS.",
  "designlab.showcase.component.tree.live.doctorShell.meta": "3 routes",
  "designlab.showcase.component.tree.live.security.label": "Security contract",
  "designlab.showcase.component.tree.live.security.description":
    "Residual risk and live provisioning rules.",
  "designlab.showcase.component.tree.live.security.meta": "review",
  "designlab.showcase.component.tree.live.security.badge": "Policy",
  ...
  "designlab.showcase.component.tree.live.securityResidual.description":
    "Remaining scheduled risks are tracked through a mandatory review.",
  ...
  "designlab.showcase.component.tree.sections.releaseGovernance.description":
    "Tracks doctor, security and policy flows in a single hierarchical tree.",
  ...
  "designlab.showcase.component.tree.sections.releaseGovernance.usage":
    "`Tree` provides hierarchy for approval flow, rollout ownership and policy breakdown without breaking the sense of depth.",
  ...
  "designlab.showcase.component.tree.sections.readonlyAudit.description":
    "Shows readonly state, compact density and selected node behavior together.",
  ...
  "designlab.showcase.component.tree.sections.readonlyAudit.emptyState":
    "Hierarchy not found.",
  "designlab.showcase.component.treeTable.shared.columns.owner": "Owner",
  "designlab.showcase.component.treeTable.shared.columns.status": "Status",
  "designlab.showcase.component.treeTable.shared.columns.scope": "Scope",
  ...
  "designlab.showcase.component.treeTable.live.ownershipMatrix.description":
    "Reads owner, status and scope with hierarchical rows.",
  ...
  "designlab.showcase.component.treeTable.live.platformUi.description":
    "Core design system owner team.",
  "designlab.showcase.component.treeTable.live.platformUi.meta": "stable",
  "designlab.showcase.component.treeTable.live.platformUi.badge": "Owner",
  ...
  "designlab.showcase.component.treeTable.live.uiLibrarySurface.description":
    "Docs, preview and API catalog surface.",
  ...
  "designlab.showcase.component.treeTable.live.deliveryGates.description":
    "Wave gate and doctor evidence chain.",
  ...
  "designlab.showcase.component.treeTable.sections.ownershipMatrix.description":
    "TreeTable combines owner / status / scope data with hierarchical rows.",
  ...
  "designlab.showcase.component.treeTable.sections.ownershipMatrix.usage":
    "`TreeTable` compares columns without losing hierarchy in entity or ownership trees.",
  ...
  "designlab.showcase.component.treeTable.sections.compactReview.description":
    "Shows compact density, selected rows and loading/empty fallback behavior together.",
  ...
  "designlab.showcase.component.treeTable.sections.compactReview.emptyState":
    "No hierarchical table record.",
  "designlab.showcase.component.tabs.controlled.title": "Controlled tabs",
  "designlab.showcase.component.tabs.controlled.overview.label": "Overview",
  ...
  "designlab.showcase.component.tabs.controlled.overview.description":
    "Track release readiness, activity signals and adoption without leaving the current surface.",
  "designlab.showcase.component.tabs.controlled.activity.label": "Activity",
  ...
  "designlab.showcase.component.tabs.controlled.activity.description":
    "Review recent navigation, user actions and state transitions inside the same tab contract.",
  "designlab.showcase.component.tabs.controlled.settings.label": "Settings",
  "designlab.showcase.component.tabs.manual.title": "Manual vertical tabs",
  ...
  "designlab.showcase.component.tabs.manual.tokens.content":
    "Inspect spacing, radius and color contracts in a manual vertical tab flow.",
  "designlab.showcase.component.tabs.manual.density.label": "Density",
  "designlab.showcase.component.tabs.manual.density.content":
    "Switch between compact and comfortable patterns without changing the container shell.",
  "designlab.showcase.component.tabs.manual.motion.label": "Motion",
  "designlab.showcase.component.tabs.manual.motion.content":
    "Keep reduced-motion and animation guidance in the same controlled navigation surface.",

  // ── Foundation detail section keys ──
  "designlab.foundation.overview.empty":
    "Select a foundation family to view its overview.",
  "designlab.foundation.overview.workspace.title": "Foundation overview",
  "designlab.foundation.overview.workspace.description":
    "System summary, token governance and foundation-level decision framing.",
  "designlab.foundation.overview.summary": "Summary",
  "designlab.foundation.overview.quickStatus": "Quick status",
  "designlab.foundation.api.empty":
    "Select a foundation family to view its API contract.",
  "designlab.foundation.quality.empty":
    "Select a foundation family to view its quality gates.",

  // ── Ecosystem detail section keys ──
  "designlab.ecosystem.overview.empty":
    "Select an extension to view its overview.",
  "designlab.ecosystem.api.empty":
    "Select an extension to view its API contract.",
  "designlab.ecosystem.quality.empty":
    "Select an extension to view its quality gates.",

  // ── Showcase: ApprovalCheckpoint readonly keys ──
  ...
  "designlab.showcase.component.approvalCheckpoint.sections.readonly.note":
    "Read-only approval checkpoint with decision and evidence context.",
  ...
  "designlab.showcase.component.textArea.sections.authoring.counter.note":
    "Shows real-time character count as the user types.",
  ...
  // ── Foundation tab label overrides ──
  "designlab.tabs.demo.label.foundations": "Preview",
  "designlab.tabs.api.label.foundations": "API",
  "designlab.tabs.overview.label.foundations": "Overview",
  "designlab.tabs.quality.label.foundations": "Quality",
  "designlab.tabs.ux.label.foundations": "UX",

  // ── Route-based Design Lab (Faz 1) ──

  // Landing page
  "designlab.landing.title": "Design Lab",
  "designlab.landing.subtitle":
    "Explore {count} design system components, recipes and page templates.",
  "designlab.landing.search.placeholder": "Search all components, recipes, pages...",
  "designlab.landing.items": "items",
  "designlab.landing.layer.foundations.title": "Foundations",
  "designlab.landing.layer.foundations.description":
    "Theme tokens, accessibility, i18n and runtime utilities.",
  "designlab.landing.layer.components.title": "Components",
  "designlab.landing.layer.components.description":
    "Reusable UI building blocks — buttons, inputs, tables and more.",
  "designlab.landing.layer.recipes.title": "Recipes",
  "designlab.landing.layer.recipes.description":
    "Multi-component workflow patterns and product flows.",
  "designlab.landing.layer.pages.title": "Pages",
  "designlab.landing.layer.pages.description":
    "Full-page templates — dashboards, CRUD, detail and settings.",
  "designlab.landing.layer.ecosystem.title": "Ecosystem",
  "designlab.landing.layer.ecosystem.description":
    "Enterprise extensions, data grids and premium surfaces.",

  // New 8-layer navigation
  "designlab.landing.layer.design.title": "Design Tokens",
  "designlab.landing.layer.design.description":
    "Color palette, typography, spacing, radius, motion and z-index tokens.",
  "designlab.landing.layer.theme.title": "Theme Builder",
  "designlab.landing.layer.theme.description":
    "10-axis theme playground — appearance, density, radius, elevation and more.",
  "designlab.landing.layer.primitives.title": "Primitives",
  "designlab.landing.layer.primitives.description":
    "Single-element building blocks — Text, Button, Input, Badge, Avatar and more.",
  "designlab.landing.layer.patterns.title": "Patterns",
  "designlab.landing.layer.patterns.description":
    "Page-level layout shells — dashboards, CRUD, detail and settings templates.",
  "designlab.landing.layer.advanced.title": "Advanced",
  "designlab.landing.layer.advanced.description":
    "Heavy third-party integrations — AG Grid, charts and enterprise data surfaces.",
  ...
  // New layer sidebar titles, help, and search
  "designlab.sidebar.title.design": "Design Tokens",
  "designlab.sidebar.title.theme": "Theme Builder",
  "designlab.sidebar.title.primitives": "Primitives",
  "designlab.sidebar.title.patterns": "Page Patterns",
  "designlab.sidebar.title.advanced": "Advanced",
  "designlab.sidebar.help.design":
    "Browse design tokens — colors, typography, spacing, radius, motion and z-index scales.",
  "designlab.sidebar.help.theme":
    "Explore and customize the 10 independent theme axes that control appearance, density and style.",
  "designlab.sidebar.help.primitives":
    "Single-element building blocks with zero cross-dependencies. The atomic foundation of the design system.",
  "designlab.sidebar.help.patterns":
    "Page-level layout shells and templates — dashboards, CRUD pages, detail views and settings.",
  "designlab.sidebar.help.advanced":
    "Enterprise-grade components built on heavy third-party libraries like AG Grid.",
  "designlab.sidebar.search.design.placeholder": "Search tokens...",
  "designlab.sidebar.search.theme.placeholder": "Search theme axes...",
  "designlab.sidebar.search.primitives.placeholder": "Search primitives...",
  "designlab.sidebar.search.patterns.placeholder": "Search patterns...",
  "designlab.sidebar.search.advanced.placeholder": "Search advanced...",

  // Token group titles and descriptions
  "designlab.tokenGroup.colors.title": "Colors",
  "designlab.tokenGroup.colors.description":
    "Color palette and semantic color tokens — primary, surface, text, border and state colors.",
  "designlab.tokenGroup.typography.title": "Typography",
  "designlab.tokenGroup.typography.description":
    "Font families, sizes, weights, line heights and letter spacing scales.",
  "designlab.tokenGroup.spacing.title": "Spacing",
  "designlab.tokenGroup.spacing.description":
    "4px-grid spacing scale from 0 to 128px for consistent layouts.",
  "designlab.tokenGroup.radius.title": "Border Radius",
  "designlab.tokenGroup.radius.description":
    "Corner radius tokens from sharp (none) to fully rounded (full).",
  "designlab.tokenGroup.motion.title": "Motion",
  "designlab.tokenGroup.motion.description":
    "Duration and easing tokens for consistent animations and transitions.",
  "designlab.tokenGroup.zindex.title": "Z-Index",
  "designlab.tokenGroup.zindex.description":
    "Layering tokens for overlays, dropdowns, modals and tooltips.",

  // Theme axis titles and descriptions
  "designlab.themeAxis.appearance.title": "Appearance",
  "designlab.themeAxis.appearance.description": "Light and dark color schemes.",
  "designlab.themeAxis.density.title": "Density",
  "designlab.themeAxis.density.description": "Compact, default, or comfortable spacing.",
  "designlab.themeAxis.radius.title": "Radius",
  "designlab.themeAxis.radius.description": "Sharp, default, rounded, or pill corners.",
  "designlab.themeAxis.elevation.title": "Elevation",
  "designlab.themeAxis.elevation.description": "Flat, subtle, or raised shadow levels.",
  "designlab.themeAxis.motion.title": "Motion",
  "designlab.themeAxis.motion.description": "None, reduced, default, or playful animations.",
  "designlab.themeAxis.tableSurfaceTone.title": "Table Surface",
  "designlab.themeAxis.tableSurfaceTone.description": "Plain, striped, or bordered table styles.",
  "designlab.themeAxis.surfaceTone.title": "Surface Tone",
  "designlab.themeAxis.surfaceTone.description": "Cool, neutral, or warm surface temperatures.",
  "designlab.themeAxis.accent.title": "Accent",
  "designlab.themeAxis.accent.description": "Primary accent color — blue, violet, emerald, amber, or rose.",
  "designlab.themeAxis.overlayIntensity.title": "Overlay Intensity",
  "designlab.themeAxis.overlayIntensity.description": "Subtle, default, or strong overlay backgrounds.",
  "designlab.themeAxis.overlayOpacity.title": "Overlay Opacity",
  "designlab.themeAxis.overlayOpacity.description": "Light, default, or heavy overlay transparency.",

  // Sidebar (route-aware additions)
  "designlab.sidebar.itemCount": "{count} items",
  "designlab.sidebar.empty.search":
    "No results for \"{query}\". Try a different search.",
  "designlab.sidebar.empty.default": "No items in this layer yet.",
  "designlab.sidebar.page.defaultCluster": "Page templates",

  // Detail pages
  "designlab.detail.notFound": "Item not found.",
  "designlab.detail.comingSoon":
    "Detailed content is being prepared. Full tabs will be available in the next release.",
  "designlab.detail.copyImport": "Copy import statement",
  "designlab.detail.tab.overview": "Overview",
  "designlab.detail.tab.playground": "Playground",
  "designlab.detail.tab.api": "API",
  "designlab.detail.tab.examples": "Examples",
  "designlab.detail.tab.guide": "Guide",
  "designlab.detail.tab.tokens": "Tokens",
  "designlab.detail.tab.style": "Style",
  "designlab.detail.tab.quality": "Quality",
  "designlab.detail.tab.changelog": "Changelog",
  "designlab.detail.overview.keyProps": "Key props",
  "designlab.detail.overview.variants": "Variant axes",
  "designlab.detail.overview.stateModel": "State model",
  "designlab.detail.overview.whereUsed": "Used in",
  "designlab.detail.playground.title": "Interactive Playground",
  "designlab.detail.playground.comingSoon":
    "Live prop editor for {name} is coming soon.",
  "designlab.detail.api.empty": "No API documentation available yet.",
  "designlab.detail.api.prop": "Prop",
  "designlab.detail.api.type": "Type",
  "designlab.detail.api.default": "Default",
  "designlab.detail.api.required": "Required",
  "designlab.detail.api.description": "Description",
  "designlab.detail.examples.comingSoon":
    "Usage examples for {name} are being prepared.",
  "designlab.detail.quality.gates": "Quality gates",
  "designlab.detail.quality.noGates": "No quality gates defined yet.",
  "designlab.search.hint.navigate": "Navigate",
  "designlab.search.hint.select": "Select",
  "designlab.sidebar.empty.noResults": "No results found.",

  "designlab.recipe.tab.overview": "Overview",
  "designlab.recipe.tab.workflow": "Workflow",
  "designlab.recipe.tab.components": "Components",
  "designlab.recipe.tab.quality": "Quality",
  "designlab.recipe.overview.intent": "Purpose",
  "designlab.recipe.overview.ownerBlocks": "Owner blocks",
  "designlab.recipe.overview.usedComponents": "Used components",
  "designlab.recipe.workflow.title": "Workflow diagram",
  "designlab.recipe.workflow.steps": "Workflow Steps",
  "designlab.recipe.workflow.states": "Lifecycle States",
  "designlab.recipe.workflow.qualityGates": "Quality Gates",
  "designlab.recipe.workflow.dependencies": "Dependencies",
  "designlab.recipe.workflow.complexity": "Complexity",
  "designlab.recipe.workflow.noPattern":
    "No workflow pattern defined for this recipe.",
  "designlab.recipe.workflow.step": "Step {number}",
  "designlab.recipe.components.empty":
    "No components are linked to this recipe yet.",

  "designlab.page.tab.overview": "Overview",
  "designlab.page.tab.regions": "Regions",
  "designlab.page.tab.components": "Components",
  "designlab.page.tab.quality": "Quality",
  "designlab.page.overview.intent": "Purpose",
  "designlab.page.overview.cluster": "Cluster",
  "designlab.page.overview.ownerBlocks": "Owner blocks",
  "designlab.page.overview.usedComponents": "Used components",
  "designlab.page.regions.title": "Page regions",
  "designlab.page.regions.wireframe": "Page Layout Structure",
  "designlab.page.regions.zone.header": "Header",
  "designlab.page.regions.zone.toolbar": "Toolbar",
  "designlab.page.regions.zone.main": "Main Content",
  "designlab.page.regions.zone.sidebar": "Side Panel",
  "designlab.page.regions.zone.footer": "Footer",
  "designlab.page.regions.zone.utilities": "Utilities",
  "designlab.page.regions.sectionComponents": "Section Components",
  "designlab.page.regions.noRegions":
    "No region data available for this template.",
  "designlab.page.components.empty":
    "No components are linked to this page template yet.",

  "designlab.extension.tab.overview": "Overview",
  "designlab.extension.tab.surfaces": "Surfaces",
  "designlab.extension.tab.components": "Components",
  "designlab.extension.tab.quality": "Quality",
  "designlab.extension.overview.intent": "Purpose",
  "designlab.extension.overview.ownerBlocks": "Owner blocks",
  "designlab.extension.overview.usedComponents": "Used components",
  "designlab.extension.surfaces.title": "Extension surfaces",
  "designlab.extension.surfaces.integrations": "Integration Surfaces",
  "designlab.extension.surfaces.tier.pro": "Pro",
  "designlab.extension.surfaces.tier.enterprise": "Enterprise",
  "designlab.extension.surfaces.coreComponents": "Core Components",
  "designlab.extension.surfaces.capabilities": "Capabilities",
  "designlab.extension.surfaces.readiness": "Enterprise Readiness",
  "designlab.extension.surfaces.apiContract": "API Contract",
  "designlab.extension.surfaces.benchmarks": "Benchmark Equivalents",
  "designlab.extension.surfaces.qualityGates": "Quality Gates",
  "designlab.extension.surfaces.noSurfaces":
    "No surface data available for this extension.",
  "designlab.extension.components.empty":
    "No components are linked to this extension yet.",

  "designlab.playground.title": "Interactive Playground",
  "designlab.playground.noApi":
    "No API documentation available for {name}. Add variant axes and props to enable the playground.",
  "designlab.playground.preview": "Preview",
  "designlab.playground.controls": "Controls",
  "designlab.playground.group.variants": "Variants",
  "designlab.playground.group.state": "State",
  "designlab.playground.group.props": "Props",
  "designlab.playground.resetAll": "Reset all",
  "designlab.detail.api.yes": "Yes",
  "designlab.detail.api.no": "No",

  // Icon Gallery
  "designlab.iconGallery.title": "Icon Gallery",
  "designlab.iconGallery.description":
    "Browse, search and copy 1800+ icons from the lucide-react icon library. Click any icon to copy its import statement.",
  "designlab.iconGallery.searchPlaceholder": "Search icons… (press / to focus)",
  "designlab.iconGallery.copyHint": "Click to copy import",

  // Bundle Size
  "designlab.bundleSize.title": "Bundle Size Analysis",
  "designlab.bundleSize.description":
    "Estimated gzip sizes for every design-system component. Keep an eye on your import footprint.",
};
