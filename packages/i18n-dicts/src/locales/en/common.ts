const common = {
  ...
  'shell.mega.hr.interviewEvidence.desc': 'Interview evidence and human review workspace',
  'shell.mega.hr.atsProductHub': 'ATS Product Hub',
  'shell.mega.hr.atsProductHub.desc': 'ATS capabilities, safe previews, and live-module launch',
  ...
  'shell.mega.admin.endpointAdmin.desc': 'Endpoint device management and commands',
  ...
  'shell.breadcrumb.atsProductHub': 'ATS Product Hub',
