const access = {
  ...
  'access.drawer.reportsActiveCount': '{active}/{total} active',
  'access.drawer.reportsTotal': '{total} reports',
  ...
  'access.drawer.actionsActiveCount': '{active}/{total} active',
  'access.drawer.actionsTotal': '{total} actions',
  'access.drawer.actionsBulkLevelAria': 'Bulk grant for all actions in module {module}',
  'access.drawer.actionsBulkMixed': 'Mixed',
  'access.drawer.actionsLevel.none': 'No Access',
  'access.drawer.actionsLevel.allow': 'Allow',
  'access.drawer.actionsLevel.deny': 'Deny',
