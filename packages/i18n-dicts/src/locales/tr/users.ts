const users = {
  ...
  'users.detail.mfa.methods.hint': 'Hiçbiri seçili değilse kısıtlama yok: kullanılabilir her yöntem sunulur.',
  'users.detail.mfa.methods.sms': 'SMS',
  'users.detail.mfa.methods.email': 'E-posta',
  'users.detail.mfa.methods.totpNote': 'Doğrulama uygulaması her zaman sunulur; kurulu olduğunda buradan kapatılamaz.',
