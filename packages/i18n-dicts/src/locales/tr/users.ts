const users = {
  ...
  'users.detail.mfa.required.enabled': 'İkinci adım bu kullanıcı için zorunlu kılındı.',
  'users.detail.mfa.required.disabled': 'İkinci adım zorunluluğu kaldırıldı.',
  'users.detail.mfa.required.failed': 'İkinci adım zorunluluğu değiştirilemedi.',
  'users.detail.mfa.methods.title': 'Sunulacak yöntemler',
  'users.detail.mfa.methods.hint': 'İşaretli yöntemler bu kullanıcıya sunulur. Kaldırmak için işareti kaldırın; hepsi işaretliyse kısıtlama yoktur.',
  'users.detail.mfa.methods.sms': 'SMS',
  'users.detail.mfa.methods.email': 'E-posta',
  'users.detail.mfa.methods.totp': 'Doğrulama uygulaması',
  'users.detail.mfa.methods.totpNote': 'Kilitlenmeyi önlemek için: başka hiçbir yöntem bu kullanıcıda kullanılamıyorsa doğrulama uygulaması işaretsiz olsa da sunulur.',
  'users.detail.mfa.methods.saved': 'Yöntem kısıtlaması güncellendi.',
  'users.detail.mfa.methods.failed': 'Yöntem kısıtlaması değiştirilemedi.',
