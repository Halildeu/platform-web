const access = {
  ...
  'access.drawer.reportsActiveCount': '{active}/{total} aktif',
  'access.drawer.reportsTotal': '{total} rapor',
  ...
  'access.drawer.actionsActiveCount': '{active}/{total} aktif',
  'access.drawer.actionsTotal': '{total} eylem',
  'access.drawer.actionsBulkLevelAria': '{module} modülündeki tüm eylemler için toplu yetki',
  'access.drawer.actionsBulkMixed': 'Karışık',
  'access.drawer.actionsLevel.none': 'Yetki Yok',
  'access.drawer.actionsLevel.allow': 'İzin',
  'access.drawer.actionsLevel.deny': 'Engel',
