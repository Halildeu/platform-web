const designlab_componentContracts = {
  ...
  'designlab.componentContracts.pagination.previousPageAriaLabel': 'Vorherige Seite',
  ...
  'designlab.componentContracts.pagination.pageIndicatorLabel': 'Seite {currentPage} / {pageCount}',
  ...
  'designlab.componentContracts.timePicker.emptyValueLabel': 'Uhrzeit auswahlen',
  'designlab.componentContracts.tableSimple.emptyFallbackDescription': 'Keine Eintrage gefunden.',
  'designlab.componentContracts.tree.emptyFallbackDescription': 'Keine Eintrage gefunden.',
  ...
  'designlab.componentContracts.treeTable.emptyFallbackDescription': 'Keine Eintrage gefunden.',
  'designlab.componentContracts.treeTable.expandNodeAriaLabel': 'Zweig aufklappen',
  'designlab.componentContracts.treeTable.collapseNodeAriaLabel': 'Zweig einklappen',
  ...
  'designlab.componentContracts.tourCoachmarks.nextStepLabel': 'Naechster Schritt',
  'designlab.componentContracts.tourCoachmarks.finishLabel': 'Fertig',
  'designlab.componentContracts.tourCoachmarks.readonlyFinishLabel': 'Tour abgeschlossen',
  'designlab.componentContracts.agGridServer.loadingLabel': 'Wird geladen...',
  'designlab.componentContracts.entityGridTemplate.defaultVariantName': 'Unbenannte Variante',
  ...
  'designlab.componentContracts.entityGridTemplate.quickFilterLabel': 'Schnellfilter',
  'designlab.componentContracts.entityGridTemplate.variantLabel': 'Variante',
  'designlab.componentContracts.entityGridTemplate.densityToggleLabel': 'Zeilendichte',
  'designlab.componentContracts.entityGridTemplate.comfortableDensityLabel': 'Komfortabel',
  'designlab.componentContracts.entityGridTemplate.compactDensityLabel': 'Kompakt',
  ...
  'designlab.componentContracts.entityGridTemplate.resetFiltersLabel': 'Filter zurucksetzen',
  'designlab.componentContracts.entityGridTemplate.excelVisibleLabel': 'Excel (sichtbar)',
  'designlab.componentContracts.entityGridTemplate.excelAllLabel': 'Excel (alle)',
  'designlab.componentContracts.entityGridTemplate.csvVisibleLabel': 'CSV (sichtbar)',
  'designlab.componentContracts.entityGridTemplate.csvAllLabel': 'CSV (alle)',
  'designlab.componentContracts.entityGridTemplate.variantModalTitle': 'Variantenverwaltung',
  ...
  'designlab.componentContracts.entityGridTemplate.variantsCreateNewLabel':
    'Neue Variante erstellen',
  'designlab.componentContracts.entityGridTemplate.overlayLoadingLabel':
    'Eintrage werden geladen...',
  'designlab.componentContracts.entityGridTemplate.overlayNoRowsLabel': 'Keine Eintrage gefunden',
  ...
  'designlab.componentContracts.entityGridTemplate.pageSizeLabel': 'Seitengrosse:',
  ...
  'designlab.componentContracts.entityGridTemplate.firstPageLabel': 'Erste Seite',
  'designlab.componentContracts.entityGridTemplate.previousPageLabel': 'Vorherige Seite',
  'designlab.componentContracts.entityGridTemplate.nextPageLabel': 'Nachste Seite',
  'designlab.componentContracts.entityGridTemplate.lastPageLabel': 'Letzte Seite',
  ...
  'designlab.componentContracts.entityGridTemplate.manageVariantsLabel': 'Varianten verwalten',
  'designlab.componentContracts.entityGridTemplate.closeVariantManagerLabel':
    'Variantenverwaltung schliessen',
  'designlab.componentContracts.entityGridTemplate.personalVariantsTitle': 'Personliche Varianten',
  'designlab.componentContracts.entityGridTemplate.personalVariantsEmptyLabel':
    'Noch keine personliche Variante.',
  'designlab.componentContracts.entityGridTemplate.globalVariantsTitle': 'Globale Varianten',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.selectAll': 'Alle auswahlen',
  'designlab.componentContracts.entityGridTemplate.localeText.searchOoo': 'Suchen...',
  'designlab.componentContracts.entityGridTemplate.localeText.filterOoo': 'Filtern...',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.previous': 'Zuruck',
  'designlab.componentContracts.entityGridTemplate.localeText.columns': 'Spalten',
  'designlab.componentContracts.entityGridTemplate.localeText.filters': 'Filter',
  'designlab.componentContracts.entityGridTemplate.localeText.collapseAll': 'Alle einklappen',
  'designlab.componentContracts.entityGridTemplate.localeText.expandAll': 'Alle aufklappen',
  'designlab.componentContracts.entityGridTemplate.localeText.pinColumn': 'Spalte anheften',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.groupBy': 'Gruppieren nach',
  'designlab.componentContracts.entityGridTemplate.localeText.resetColumns': 'Spalten zurucksetzen',
  'designlab.componentContracts.entityGridTemplate.localeText.resetFilters': 'Filter zurucksetzen',
  'designlab.componentContracts.entityGridTemplate.localeText.toolPanelButton': 'Werkzeugleiste',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuPin': 'Angeheftet',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuValue': 'Werte',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuGroup': 'Gruppen',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuSort': 'Sortieren',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuFilter': 'Spaltenfilter',
  'designlab.componentContracts.entityGridTemplate.localeText.applyFilter': 'Anwenden',
  'designlab.componentContracts.entityGridTemplate.localeText.clearFilter': 'Zurucksetzen',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.notEqual': 'Ungleich',
  'designlab.componentContracts.entityGridTemplate.localeText.lessThan': 'Kleiner als',
  'designlab.componentContracts.entityGridTemplate.localeText.lessThanOrEqual':
    'Kleiner oder gleich',
  'designlab.componentContracts.entityGridTemplate.localeText.greaterThan': 'Grosser als',
  'designlab.componentContracts.entityGridTemplate.localeText.greaterThanOrEqual':
    'Grosser oder gleich',
  'designlab.componentContracts.entityGridTemplate.localeText.inRange': 'Im Bereich',
  'designlab.componentContracts.entityGridTemplate.localeText.contains': 'Enthalt',
  'designlab.componentContracts.entityGridTemplate.localeText.notContains': 'Enthalt nicht',
  'designlab.componentContracts.entityGridTemplate.localeText.startsWith': 'Beginnt mit',
  'designlab.componentContracts.entityGridTemplate.localeText.endsWith': 'Endet mit',
  'designlab.componentContracts.entityGridTemplate.localeText.blank': 'Leer',
  'designlab.componentContracts.entityGridTemplate.localeText.notBlank': 'Nicht leer',
  ...
  'designlab.componentContracts.jsonViewer.emptyNodeDescription': 'Dieser Knoten ist leer.',
  ...
  'designlab.componentContracts.descriptions.emptyFallbackDescription': 'Keine Details gefunden.',
  'designlab.componentContracts.list.emptyFallbackDescription': 'Keine Einträge gefunden.',
  'designlab.componentContracts.linkInline.externalScreenReaderLabel': 'Externer Link',
  ...
  'designlab.componentContracts.themePreviewCard.selectedLabel': 'Ausgewählte Theme-Vorschau',
  ...
  'designlab.componentContracts.entityGridTemplate.variantOptionGlobalLabel': 'Systemweit',
  'designlab.componentContracts.entityGridTemplate.variantOptionGlobalDefaultLabel':
    'Systemweit Standard',
  'designlab.componentContracts.entityGridTemplate.variantOptionDefaultLabel': 'Standard',
  'designlab.componentContracts.entityGridTemplate.variantOptionIncompatibleLabel': 'Inkompatibel',
  ...
  'designlab.componentContracts.entityGridTemplate.variantSavedLabel': 'Variante gespeichert.',
  ...
  'designlab.componentContracts.entityGridTemplate.variantCreatedLabel': 'Variante erstellt.',
  ...
  'designlab.componentContracts.entityGridTemplate.variantDeletedLabel': 'Variante geloescht.',
  'designlab.componentContracts.entityGridTemplate.variantDeleteFailedLabel':
    'Variante konnte nicht geloescht werden.',
  'designlab.componentContracts.entityGridTemplate.menuSelectLabel': 'Ansicht anwenden',
  'designlab.componentContracts.entityGridTemplate.menuRenameLabel': 'Umbenennen',
  ...
  'designlab.componentContracts.entityGridTemplate.menuMoveToGlobalLabel': 'Systemweit freigeben',
  ...
  'designlab.componentContracts.entityGridTemplate.selectedTagLabel': 'Aktuell ausgewaehlt',
  'designlab.componentContracts.entityGridTemplate.globalPublicDefaultTagLabel':
    'Geteilt · Standard',
  'designlab.componentContracts.entityGridTemplate.globalPublicTagLabel': 'Geteilt',
  'designlab.componentContracts.entityGridTemplate.personalTagLabel': 'Persoenlich',
  'designlab.componentContracts.entityGridTemplate.personalDefaultTagLabel':
    'Mein persoenlicher Standard',
  'designlab.componentContracts.entityGridTemplate.recentlyUsedTagLabel': 'Zuletzt verwendet',
  'designlab.componentContracts.entityGridTemplate.incompatibleTagLabel': 'Inkompatibel',
  'designlab.componentContracts.entityGridTemplate.hideDetailsLabel': 'Details ausblenden',
  'designlab.componentContracts.entityGridTemplate.showDetailsLabel': 'Details anzeigen',
  'designlab.componentContracts.entityGridTemplate.variantActionsLabel': 'Variantenaktionen',
  ...
  'designlab.componentContracts.entityGridTemplate.saveCurrentStateLabel': 'Status speichern',
  'designlab.componentContracts.entityGridTemplate.personalDefaultSwitchLabel':
    'Mein persoenlicher Standard',
  'designlab.componentContracts.entityGridTemplate.globalDefaultSwitchLabel': 'Globaler Standard',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.andCondition': 'Und',
  'designlab.componentContracts.entityGridTemplate.localeText.orCondition': 'Oder',
  'designlab.componentContracts.entityGridTemplate.localeText.rowGroupPanel': 'Gruppen',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.dropZoneColumnValue':
    'Spalten hierher ziehen, um Werte zu berechnen',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilter': 'Erweiterter Filter',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterJoinOperator':
    'Verknuepfung',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterAnd': 'UND',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterOr': 'ODER',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterValidationMissingValue':
    'Wert eingeben',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterApply': 'Anwenden',
};
