const designlab_componentContracts = {
  ...
  'designlab.componentContracts.pagination.previousPageAriaLabel': 'Pagina anterior',
  'designlab.componentContracts.pagination.nextPageAriaLabel': 'Pagina siguiente',
  ...
  'designlab.componentContracts.pagination.totalItemsLabel': '{count} registros',
  'designlab.componentContracts.pagination.mode.server': 'Modo del lado del servidor',
  'designlab.componentContracts.pagination.mode.client': 'Modo del lado del cliente',
  'designlab.componentContracts.datePicker.emptyValueLabel': 'Seleccionar fecha',
  ...
  'designlab.componentContracts.tree.emptyFallbackDescription': 'No se encontraron registros.',
  ...
  'designlab.componentContracts.treeTable.emptyFallbackDescription': 'No se encontraron registros.',
  'designlab.componentContracts.treeTable.expandNodeAriaLabel': 'Expandir rama',
  'designlab.componentContracts.treeTable.collapseNodeAriaLabel': 'Contraer rama',
  ...
  'designlab.componentContracts.tourCoachmarks.readonlyFinishLabel': 'Recorrido completado',
  'designlab.componentContracts.agGridServer.loadingLabel': 'Cargando...',
  'designlab.componentContracts.entityGridTemplate.defaultVariantName': 'Variante sin titulo',
  ...
  'designlab.componentContracts.entityGridTemplate.densityToggleLabel': 'Densidad de filas',
  'designlab.componentContracts.entityGridTemplate.comfortableDensityLabel': 'Comoda',
  'designlab.componentContracts.entityGridTemplate.compactDensityLabel': 'Compacta',
  ...
  'designlab.componentContracts.entityGridTemplate.resetFiltersLabel': 'Restablecer filtros',
  'designlab.componentContracts.entityGridTemplate.excelVisibleLabel': 'Excel (visible)',
  'designlab.componentContracts.entityGridTemplate.excelAllLabel': 'Excel (todo)',
  ...
  'designlab.componentContracts.entityGridTemplate.variantModalTitle': 'Gestor de variantes',
  'designlab.componentContracts.entityGridTemplate.variantNewButtonLabel': 'Crear nueva variante',
  ...
  'designlab.componentContracts.entityGridTemplate.variantsEmptyHintLabel':
    'Aun no hay variantes guardadas',
  'designlab.componentContracts.entityGridTemplate.variantsCreateNewLabel': 'Crear nueva variante',
  'designlab.componentContracts.entityGridTemplate.overlayLoadingLabel': 'Cargando registros...',
  ...
  'designlab.componentContracts.entityGridTemplate.pageSizeLabel': 'Tamano de pagina:',
  ...
  'designlab.componentContracts.entityGridTemplate.pageIndicatorLabel':
    'Pagina {currentPage} / {pageCount}',
  'designlab.componentContracts.entityGridTemplate.firstPageLabel': 'Primera pagina',
  'designlab.componentContracts.entityGridTemplate.previousPageLabel': 'Pagina anterior',
  'designlab.componentContracts.entityGridTemplate.nextPageLabel': 'Pagina siguiente',
  'designlab.componentContracts.entityGridTemplate.lastPageLabel': 'Ultima pagina',
  ...
  'designlab.componentContracts.entityGridTemplate.manageVariantsLabel': 'Gestionar variantes',
  'designlab.componentContracts.entityGridTemplate.closeVariantManagerLabel':
    'Cerrar gestor de variantes',
  'designlab.componentContracts.entityGridTemplate.personalVariantsTitle': 'Variantes personales',
  'designlab.componentContracts.entityGridTemplate.personalVariantsEmptyLabel':
    'Todavia no hay variantes personales.',
  'designlab.componentContracts.entityGridTemplate.globalVariantsTitle': 'Variantes globales',
  'designlab.componentContracts.entityGridTemplate.globalVariantsEmptyLabel':
    'Todavia no hay variantes globales.',
  'designlab.componentContracts.entityGridTemplate.dismissToastLabel': 'Cerrar notificacion',
  'designlab.componentContracts.entityGridTemplate.localeText.selectAll': 'Seleccionar todo',
  'designlab.componentContracts.entityGridTemplate.localeText.searchOoo': 'Buscar...',
  'designlab.componentContracts.entityGridTemplate.localeText.filterOoo': 'Filtrar...',
  'designlab.componentContracts.entityGridTemplate.localeText.blanks': '(Vacio)',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.next': 'Siguiente',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.previous': 'Anterior',
  'designlab.componentContracts.entityGridTemplate.localeText.columns': 'Columnas',
  'designlab.componentContracts.entityGridTemplate.localeText.filters': 'Filtros',
  'designlab.componentContracts.entityGridTemplate.localeText.collapseAll': 'Contraer todo',
  'designlab.componentContracts.entityGridTemplate.localeText.expandAll': 'Expandir todo',
  'designlab.componentContracts.entityGridTemplate.localeText.pinColumn': 'Fijar columna',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.groupBy': 'Agrupar por',
  'designlab.componentContracts.entityGridTemplate.localeText.resetColumns': 'Restablecer columnas',
  'designlab.componentContracts.entityGridTemplate.localeText.resetFilters': 'Restablecer filtros',
  'designlab.componentContracts.entityGridTemplate.localeText.toolPanelButton':
    'Panel de herramientas',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuPin': 'Fijada',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuValue': 'Valores',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuGroup': 'Grupos',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuSort': 'Ordenar',
  'designlab.componentContracts.entityGridTemplate.localeText.columnMenuFilter': 'Filtrar',
  'designlab.componentContracts.entityGridTemplate.localeText.applyFilter': 'Aplicar',
  'designlab.componentContracts.entityGridTemplate.localeText.clearFilter': 'Limpiar',
  'designlab.componentContracts.entityGridTemplate.localeText.clearFilters':
    'Limpiar todos los filtros',
  'designlab.componentContracts.entityGridTemplate.localeText.equals': 'Igual a',
  'designlab.componentContracts.entityGridTemplate.localeText.notEqual': 'Distinto de',
  'designlab.componentContracts.entityGridTemplate.localeText.lessThan': 'Menor que',
  'designlab.componentContracts.entityGridTemplate.localeText.lessThanOrEqual': 'Menor o igual que',
  'designlab.componentContracts.entityGridTemplate.localeText.greaterThan': 'Mayor que',
  'designlab.componentContracts.entityGridTemplate.localeText.greaterThanOrEqual':
    'Mayor o igual que',
  'designlab.componentContracts.entityGridTemplate.localeText.inRange': 'Dentro del rango',
  'designlab.componentContracts.entityGridTemplate.localeText.contains': 'Contiene',
  'designlab.componentContracts.entityGridTemplate.localeText.notContains': 'No contiene',
  'designlab.componentContracts.entityGridTemplate.localeText.startsWith': 'Empieza con',
  'designlab.componentContracts.entityGridTemplate.localeText.endsWith': 'Termina con',
  'designlab.componentContracts.entityGridTemplate.localeText.blank': 'Vacio',
  'designlab.componentContracts.entityGridTemplate.localeText.notBlank': 'No vacio',
  'designlab.componentContracts.empty.description': 'No se encontraron registros.',
  'designlab.componentContracts.jsonViewer.emptyFallbackDescription':
    'No hay un payload JSON disponible.',
  'designlab.componentContracts.jsonViewer.emptyNodeDescription': 'Este nodo está vacío.',
  'designlab.componentContracts.anchorToc.title': 'En esta página',
  'designlab.componentContracts.anchorToc.navigationLabel': 'Navegación en la página',
  'designlab.componentContracts.descriptions.emptyFallbackDescription':
    'No se encontraron detalles.',
  'designlab.componentContracts.list.emptyFallbackDescription': 'No se encontraron registros.',
  'designlab.componentContracts.linkInline.externalScreenReaderLabel': 'Enlace externo',
  'designlab.componentContracts.themePreviewCard.titleText': 'Texto del título',
  'designlab.componentContracts.themePreviewCard.secondaryText': 'Texto secundario',
  ...
  'designlab.componentContracts.entityGridTemplate.variantOptionGlobalLabel': 'Compartida',
  'designlab.componentContracts.entityGridTemplate.variantOptionGlobalDefaultLabel':
    'Compartida predeterminada',
  'designlab.componentContracts.entityGridTemplate.variantOptionDefaultLabel': 'Predeterminada',
  ...
  'designlab.componentContracts.entityGridTemplate.variantSavedLabel': 'Variante guardada.',
  ...
  'designlab.componentContracts.entityGridTemplate.variantCreatedLabel': 'Variante creada.',
  ...
  'designlab.componentContracts.entityGridTemplate.variantDeletedLabel': 'Variante eliminada.',
  'designlab.componentContracts.entityGridTemplate.variantDeleteFailedLabel':
    'No se pudo eliminar la variante.',
  'designlab.componentContracts.entityGridTemplate.menuSelectLabel': 'Aplicar vista',
  'designlab.componentContracts.entityGridTemplate.menuRenameLabel': 'Renombrar',
  ...
  'designlab.componentContracts.entityGridTemplate.menuMoveToPersonalLabel': 'Mover a personal',
  'designlab.componentContracts.entityGridTemplate.menuMoveToGlobalLabel': 'Compartir con todos',
  ...
  'designlab.componentContracts.entityGridTemplate.selectedTagLabel': 'Seleccion actual',
  'designlab.componentContracts.entityGridTemplate.globalPublicDefaultTagLabel':
    'Compartida · Predeterminada',
  'designlab.componentContracts.entityGridTemplate.globalPublicTagLabel': 'Compartida',
  ...
  'designlab.componentContracts.entityGridTemplate.recentlyUsedTagLabel': 'Usada recientemente',
  'designlab.componentContracts.entityGridTemplate.incompatibleTagLabel': 'Incompatible',
  'designlab.componentContracts.entityGridTemplate.hideDetailsLabel': 'Ocultar detalles',
  'designlab.componentContracts.entityGridTemplate.showDetailsLabel': 'Mostrar detalles',
  'designlab.componentContracts.entityGridTemplate.variantActionsLabel': 'Acciones de variante',
  ...
  'designlab.componentContracts.entityGridTemplate.saveCurrentStateLabel': 'Guardar estado',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.andCondition': 'Y',
  'designlab.componentContracts.entityGridTemplate.localeText.orCondition': 'O',
  'designlab.componentContracts.entityGridTemplate.localeText.rowGroupPanel': 'Grupos',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.dropZoneColumnValue':
    'Arrastra columnas aqui para valores',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilter': 'Filtro avanzado',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterJoinOperator':
    'Operador de union',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterAnd': 'Y',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterOr': 'O',
  ...
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterValidationMissingValue':
    'Introduce un valor',
  'designlab.componentContracts.entityGridTemplate.localeText.advancedFilterApply': 'Aplicar',
};
