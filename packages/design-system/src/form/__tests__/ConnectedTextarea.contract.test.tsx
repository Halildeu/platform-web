...
import type { ConnectedTextareaProps } from '../connected/ConnectedTextarea';
...
describe('ConnectedTextarea — contract', () => {
  ...
  it('renders without crash', () => {
    const { container } = render(<ConnectedTextarea {...defaultProps} />, { wrapper: Wrapper });
  ...
  it('has no accessibility violations', async () => {
    const { container } = render(<ConnectedTextarea {...defaultProps} label="Description" />, { wrapper: Wrapper });
