...
import type { ConnectedSelectProps } from '../connected/ConnectedSelect';
...
describe('ConnectedSelect — contract', () => {
  ...
  it('renders without crash', () => {
    const { container } = render(<ConnectedSelect {...defaultProps} />, { wrapper: Wrapper });
  ...
  it('has no accessibility violations', async () => {
    const { container } = render(<ConnectedSelect {...defaultProps} aria-label="Choose option" />, { wrapper: Wrapper });
