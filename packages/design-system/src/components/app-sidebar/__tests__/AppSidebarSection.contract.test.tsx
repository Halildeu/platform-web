...
describe('AppSidebarSection — contract', () => {
  ...
  it('renders without crash', () => {
    const { container } = wrap(<AppSidebarSection><span>child</span></AppSidebarSection>);
  ...
  it('forwards className', () => {
    const { container } = wrap(<AppSidebarSection className="custom"><span>child</span></AppSidebarSection>);
