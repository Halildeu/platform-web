...
describe('CommandPalette (Browser)', () => {
  ...
  it('fires onSelect when clicking a command', async () => {
    ...
    const screen = render(<CommandPalette open items={items} onSelect={onSelect} />);
  ...
  it('fires onClose when Escape is pressed', async () => {
    const onClose = vi.fn();
    const screen = render(<CommandPalette open items={items} onClose={onClose} />);
  ...
  it('renders search placeholder', async () => {
    const screen = render(<CommandPalette open items={items} placeholder="Search commands..." />);
    const input = screen.container.querySelector('input');
