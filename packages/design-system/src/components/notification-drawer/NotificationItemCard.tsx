...
export const NotificationItemCard: React.FC<NotificationItemCardProps> = ({
  ...
  return (
    <article
      ...
      title={accessReason}
      className={cn(
        "relative overflow-hidden rounded-[24px] border p-4 ring-1 ring-[var(--border-subtle)]/20 shadow-[0_26px_54px_-34px_var(--shadow-color)] backdrop-blur-sm before:pointer-events-none before:absolute before:inset-x-6 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-[var(--surface-card)] before:to-transparent",
