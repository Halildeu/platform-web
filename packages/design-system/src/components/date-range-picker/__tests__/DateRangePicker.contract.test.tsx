...
describe('DateRangePicker — contract', () => {
  ...
  it('exports expected types', () => {
    ...
    const _daterange: DateRange | undefined = undefined;
    void _daterange;
    const _presetkey: PresetKey | undefined = undefined;
    void _presetkey;
    const _daterangepreset: DateRangePreset | undefined = undefined;
    void _daterangepreset;
    const _daterangepickerprops: DateRangePickerProps | undefined = undefined;
    void _daterangepickerprops;
