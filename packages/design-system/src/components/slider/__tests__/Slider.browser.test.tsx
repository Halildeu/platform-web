...
describe('Slider (Browser)', () => {
  ...
  it('fires onValueChange when slider changes', async () => {
    ...
    const input = screen.container.querySelector('input[type="range"]') as HTMLInputElement;
