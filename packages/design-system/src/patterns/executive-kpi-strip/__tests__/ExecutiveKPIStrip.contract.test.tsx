...
describe('ExecutiveKPIStrip — contract', () => {
  ...
  it('has displayName', () => {
    expect(ExecutiveKPIStrip.displayName).toBeTruthy();
  });
  ...
  it('exports expected types', () => {
    ...
    const _kpistripsize: KPIStripSize | undefined = undefined;
    void _kpistripsize;
    const _kpimetric: KPIMetric | undefined = undefined;
    void _kpimetric;
    const _executivekpistripprops: ExecutiveKPIStripProps | undefined = undefined;
    void _executivekpistripprops;
