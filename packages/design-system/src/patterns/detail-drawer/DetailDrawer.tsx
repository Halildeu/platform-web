  ...
  const renderBody = () => {
    if (sections) {
      return sections.map((section) => (
        <div key={section.key} className="border-b border-[var(--border-subtle)] px-6 py-4 last:border-b-0">
          {section.title && (
  ...
  return (
    <div className="fixed inset-0 z-[1300] flex">
      ...
      <div
        ...
        className={cn(
          "relative ml-auto flex flex-col w-full bg-[var(--surface-default)] shadow-2xl",
