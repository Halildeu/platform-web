...
const entry: DesignLabComponentDocEntry = {
  ...
  indexItem: {
    ...
    tags: ['wave-5', 'overlay', 'stable', 'drawer', 'form'],
  ...
  apiItem: {
    ...
    props: [
      ...
      },
      {
        ...
        required: false,
        description:
          "Title block'undan once render edilen leading slot (avatar, icon, status badge). LTR-neutral isim — locale-aware layoutlar CSS ile mirror edilir. iter-43 (Codex 019dddf4).",
      },
    ],
    previewFocus: ['create flow drawer', 'readonly policy drawer', 'submit/cancel footer states'],
    regressionFocus: ['escape close parity', 'readonly submit guard', 'dialog labelling'],
  },
};
