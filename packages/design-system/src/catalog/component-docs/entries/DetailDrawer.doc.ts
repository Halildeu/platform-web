...
const entry: DesignLabComponentDocEntry = {
  ...
  indexItem: {
    ...
    sectionIds: ['component_library_management', 'overlay_components', 'accessibility_compliance'],
    qualityGates: [
      'design_tokens',
      'preview_visibility',
    ...
    tags: ['wave-5', 'overlay', 'stable', 'drawer', 'detail'],
  ...
  apiItem: {
    ...
    stateModel: ['open / closed', 'active tab', 'escape dismiss', 'readonly access hint'],
    previewStates: ['open', 'closed', 'dark-theme'],
    behaviorModel: [
      'open / closed',
      'active tab',
      'escape dismiss',
    ...
    props: [
      ...
      },
      {
        ...
        required: false,
        description:
          'Title icerigi onunde render edilen dekoratif/baglamsal slot (avatar, icon, status badge). FormDrawer.leading ile simetrik. iter-44 (Codex 019dde0c).',
      },
    ],
    previewFocus: ['tabbed review drawer', 'readonly evidence drawer', 'audit/status tab switch'],
    regressionFocus: ['tab aria wiring', 'escape close parity', 'readonly badge visibility'],
  },
};
