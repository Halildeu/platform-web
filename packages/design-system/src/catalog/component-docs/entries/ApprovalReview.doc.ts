...
const entry: DesignLabComponentDocEntry = {
  ...
  "importStatement": "import { ApprovalReview } from '@mfe/design-system';",
  "whereUsed": [
    "web/apps/mfe-shell/src/pages/admin/DesignLabPage.tsx",
    "web/apps/mfe-shell/src/pages/admin/design-lab/showcase/DesignLabShowcaseContent.tsx"
  ],
    "dependsOn": ["AIActionAuditTimeline","ApprovalCheckpoint","CitationPanel","Text"]
},
  apiItem: {
  "name": "ApprovalReview",
  "variantAxes": [
  ...
  "stateModel": [
    ...
    "previewStates": ["checkpoint-first", "evidence-first", "readonly-review", "dark-theme"],
    "behaviorModel": [
      "selected citation",
      "selected audit item",
      "approval action propagation"
