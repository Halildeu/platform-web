...
const entry: DesignLabComponentDocEntry = {
  ...
  indexItem: {
    ...
    demoMode: 'planned',
    description:
      'Kompakt satir ici sparkline grafigi; tablolar ve kartlar icinde mini trend gosterimi saglar.',
    sectionIds: ['component_library_management', 'table_data_display', 'state_feedback'],
    qualityGates: [
      'design_tokens',
      'preview_visibility',
    ...
    tags: ['wave-13', 'enterprise-x-suite', 'charts', 'planned'],
  ...
  apiItem: {
    name: 'SparklineChart',
    variantAxes: ['type: line | bar | area', 'color: primary | success | warning | danger'],
    stateModel: ['default', 'empty', 'animating'],
    previewStates: ['line-default', 'bar-mode', 'area-mode', 'empty-data', 'dark-theme'],
    behaviorModel: [
    ...
    props: [
      ...
      },
      {
        ...
        default: '120',
        required: false,
        description: "Grafik genisligi (piksel) veya `'auto'` ile parent container'a sigdir.",
      },
      {
        name: 'height',
        type: 'number',
    ...
    previewFocus: ['line vs bar vs area rendering', 'auto-scaling behavior', 'inline integration'],
    regressionFocus: [
