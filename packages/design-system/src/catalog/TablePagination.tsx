...
const DefaultTablePaginationActions: React.FC<TablePaginationActionsProps> = ({
  ...
  <div
    className={[
      'flex items-center gap-2 rounded-full border border-border-subtle/70 bg-[var(--surface-card)] px-2 py-1 shadow-[0_12px_24px_-22px_var(--shadow-color,rgba(15,23,42,0.2))] ring-1 ring-border-subtle/20 backdrop-blur-sm',
      className ?? '',
    ]
      .join(' ')
      .trim()}
