...
describe('SankeyDiagram — contract', () => {
  ...
  it('exports expected types', () => {
    ...
    const _sankeynode: SankeyNode | undefined = undefined;
    void _sankeynode;
    const _sankeylink: SankeyLink | undefined = undefined;
    void _sankeylink;
    const _sankeydiagramprops: SankeyDiagramProps | undefined = undefined;
    void _sankeydiagramprops;
