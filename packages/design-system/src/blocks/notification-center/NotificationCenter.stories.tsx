...
const sampleNotifications: NotificationItem[] = [
  {
    ...
    message: 'Purchase order #4521 requires your approval.',
    timestamp: new Date(Date.now() - 300_000).toISOString(),
    actionLabel: 'Review',
    actionPayload: { orderId: 4521 },
  },
  {
    id: 'n2',
    type: 'success',
    title: 'Deploy Completed',
    message: 'Production deployment v2.14.0 completed successfully.',
  ...
  },
  {
    ...
    message: 'Server db-primary disk usage at 87%.',
  ...
  },
  {
    ...
    message: 'Invoice #8832 payment processing failed. Retry scheduled.',
  ...
  },
  {
    ...
    message: 'System maintenance planned for Sunday 02:00-04:00.',
...
const meta: Meta<typeof NotificationCenter> = {
  title: 'Blocks/Admin/NotificationCenter',
