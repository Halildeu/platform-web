...
describe('MicroChart — contract', () => {
  ...
  it('exports expected types', () => {
    ...
    const _microcharttype: MicroChartType | undefined = undefined;
    void _microcharttype;
    const _microchartprops: MicroChartProps | undefined = undefined;
    void _microchartprops;
