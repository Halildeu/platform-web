...
const sampleItems: ActivityItem[] = [
  {
    id: '1',
    type: 'create',
    actor: { name: 'Ali Yilmaz' },
    description: 'yeni rapor olusturdu',
    target: 'Q1 Performans Raporu',
  ...
  },
  {
    ...
    description: 'onayladi',
    target: 'Butce Talebi #142',
    timestamp: new Date(now - 7200000).toISOString(),
  },
  {
    id: '4',
    type: 'assign',
    actor: { name: 'Ayse Celik' },
    description: 'gorevi atadi',
    target: 'Veri Temizleme',
    timestamp: new Date(now - 86400000).toISOString(),
  },
  {
    id: '5',
    type: 'delete',
    actor: { name: 'Can Ozturk' },
    description: 'tasagi sildi',
    target: 'Eski Draft',
  ...
  },
  {
    ...
    type: 'alert',
    actor: { name: 'Sistem' },
    description: 'uyari: disk alani %90',
    timestamp: new Date(now - 86400000 * 3).toISOString(),
  },
  {
    id: '8',
