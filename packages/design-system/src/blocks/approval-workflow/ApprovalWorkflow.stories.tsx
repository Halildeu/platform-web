...
const sampleSteps: ApprovalStep[] = [
  {
    ...
    status: 'approved',
    assignee: { id: 'u1', name: 'Ayse Demir', initials: 'AD' },
  ...
  },
  {
    ...
    label: 'Finance Check',
    status: 'approved',
    assignee: { id: 'u2', name: 'Mehmet Kaya', initials: 'MK' },
  ...
  },
  {
    ...
    label: 'Legal Review',
    status: 'in-review',
    assignee: { id: 'u3', name: 'Fatma Yilmaz', initials: 'FY' },
  },
  {
    id: '4',
    label: 'Executive Approval',
    status: 'pending',
    assignee: { id: 'u4', name: 'Ali Ozturk', initials: 'AO' },
  },
];

const meta: Meta<typeof ApprovalWorkflow> = {
  title: 'Blocks/Review/ApprovalWorkflow',
  ...
  args: {
    steps: [
      { ...sampleSteps[0], status: 'approved' as const },
      {
        ...
        comment: 'Budget exceeds quarterly allocation.',
      },
