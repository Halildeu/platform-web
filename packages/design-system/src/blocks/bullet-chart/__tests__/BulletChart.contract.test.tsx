...
describe('BulletChart — contract', () => {
  ...
  it('exports expected types', () => {
    ...
    const _bulletchartrange: BulletChartRange | undefined = undefined;
    void _bulletchartrange;
    const _bulletchartprops: BulletChartProps | undefined = undefined;
    void _bulletchartprops;
