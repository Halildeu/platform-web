...
describe('Radio (Browser)', () => {
  ...
  it('renders with label', async () => {
    const screen = await render(<Radio label="Option A" value="a" name="test" />);
    await expect.element(screen.getByText('Option A')).toBeVisible();
  });

  it('renders radio role', async () => {
    const screen = await render(<Radio label="Option" value="a" name="test" />);
  ...
  it('is disabled when disabled prop is set', async () => {
    const screen = await render(<Radio label="Disabled" value="x" name="test" disabled />);
  ...
  it('sets aria-invalid when error is truthy', async () => {
    const screen = await render(<Radio label="Error" value="a" name="test" error />);
  ...
  it('is non-interactive when loading', async () => {
    const screen = await render(<Radio label="Loading" value="a" name="test" loading />);
    await expect.element(screen.getByRole('radio')).toBeDisabled();
  });
  ...
  it('radio is focusable via tab', async () => {
    const screen = await render(<Radio label="Focusable" value="a" name="focus" />);
