    ...
    return (
      ...
      >
        ...
        >
          ...
          {loading && (
            <span className="absolute inset-0 flex items-center justify-center rounded bg-[var(--surface-default)]/60">
              <svg
                className="h-5 w-5 animate-spin text-[var(--text-secondary)]"
                viewBox="0 0 24 24"
                fill="none"
                role="status"
                aria-label="Loading"
