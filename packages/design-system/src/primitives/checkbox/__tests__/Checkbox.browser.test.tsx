...
describe('Checkbox (Browser)', () => {
  ...
  it('renders checkbox role', async () => {
    const screen = render(<Checkbox label="Check" />);
  ...
  it('fires onChange when clicked', async () => {
    ...
    const screen = render(<Checkbox label="Toggle" onChange={onChange} />);
  ...
  it('does not fire onChange when disabled', async () => {
    const onChange = vi.fn();
    const screen = render(<Checkbox label="No" disabled onChange={onChange} />);
    await screen.getByRole('checkbox').click();
  ...
  it('toggles on Space key', async () => {
    const screen = render(<Checkbox label="KB Toggle" />);
  ...
  it('renders indeterminate state', async () => {
    const screen = render(<Checkbox label="Indeterminate" indeterminate />);
  ...
  it('toggles when label is clicked', async () => {
    const screen = render(<Checkbox label="Click label" />);
    const cb = screen.getByRole('checkbox');
    await expect.element(cb).not.toBeChecked();
  ...
  it('renders all sizes without error', async () => {
    ...
    for (const size of sizes) {
      const screen = render(<Checkbox label={size} size={size} />);
      await expect.element(screen.getByRole('checkbox')).toBeVisible();
      screen.unmount();
    }
  });
  ...
  it('is non-interactive when loading', async () => {
    const onChange = vi.fn();
    const screen = render(<Checkbox label="Loading" loading onChange={onChange} />);
    await expect.element(screen.getByRole('checkbox')).toBeDisabled();
  });
  ...
  it('is focusable via tab', async () => {
    const screen = render(<Checkbox label="Focusable" />);
