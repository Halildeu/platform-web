...
export const StatWidget = React.forwardRef<HTMLDivElement, StatWidgetProps>(function StatWidget(
  {
    label,
    value,
    previousValue,
  ...
  return (
    ...
    >
      ...
      {/* ---- value ---- */}
      <Text as="div" className="mt-1 text-xl font-bold leading-none text-[var(--text-primary)]">
        {formattedValue}
      </Text>
