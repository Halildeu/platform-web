...
/* ------------------------------------------------------------------ */
/*  Spinner — Animated loading indicator (x-charts internal)           */
/*                                                                     */
/*  This is an x-charts-internal copy of the design-system Spinner    */
...
/*   - `stateAttrs` helper is inlined to avoid pulling DS internals.   */
/*     The emitted attributes (`data-component="spinner"`,             */
/*     `data-loading="true"`) match the DS Spinner output 1:1.         */
/* ------------------------------------------------------------------ */
...
export const Spinner = React.forwardRef<HTMLDivElement, SpinnerProps>(
  ({ size = 'md', className, label = 'Loading', mode = 'inline' }, ref) => {
    const svg = (
      <svg
