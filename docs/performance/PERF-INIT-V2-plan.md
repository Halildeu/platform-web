...
**Running total PERF-INIT-V2 platform-web PRs MERGED: 19** (Wave A+B closed = 12 from §9 above; Wave B5/B6 incremental = 7: #436, #437, #438, #443, #444, #446, #450). Plus 1 cross-repo MERGED: `platform-k8s-gitops` PR #550 (B3b0 edge canonical reconcile, 2026-05-13T20:17:08Z). PR-S1 cross-repo tracked separately in `platform-k8s-gitops` own audit trail. Non-PERF-INIT-V2 platform-web merges (e.g. #449 design-lab chart catalog) excluded from this count.
