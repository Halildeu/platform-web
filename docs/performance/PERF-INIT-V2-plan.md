...
| Wave-B5 decoded ROI overestimation                                                                                                         | medium   | Codex iter-2 estimates 4-8 MB on `/home` for B5a "critical-graph" scope, 8-18 MB for B5b "MFE on-demand". PR acceptance attaches before/after `bundle:taxonomy:testai` snapshot — not narrative estimates.                                              |
