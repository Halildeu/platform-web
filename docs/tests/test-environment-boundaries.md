...
| `cssom-canary-required`         | curated manifest: Tailwind sentinel + ThemeProvider + 13 primitives (Button, Input, Checkbox, Switch, Radio, Card, Dialog, Drawer, Tooltip, Alert, Skeleton, Spinner, Avatar) | required |
