const tr: Record<string, string> = {
  ...
  'dataAccess.assign.scopeRefSearchPlaceholder': 'İsim, kod veya ID ile ara...',
  'dataAccess.assign.scopeRefEmptySearch': 'Aramayla eşleşen sonuç yok.',
  'dataAccess.assign.scopeRefInactive': '(pasif)',
  'dataAccess.assign.scopeRefManualHint':
    'Liste boş — manuel ID girilebilir (master data ETL henüz koşmamış olabilir).',
