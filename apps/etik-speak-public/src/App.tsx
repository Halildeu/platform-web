  ...
  return (
    <section className="panel mailbox" aria-labelledby="mailbox-title">
      ...
      <section className="mailbox-evidence" aria-labelledby="mailbox-evidence-title">
        ...
        <p className="help">
          Yalnız sentetik UTF-8 TXT, JPEG, PNG, WebP veya PDF; en fazla 25 MiB. Güvenlik için
          PDF sayfa görüntülerine, WebP tek görsele düzleştirilerek saklanır; konum ve
          cihaz bilgisi (EXIF/GPS) türevde bulunmaz. iPhone HEIC için: fotoğrafı
          paylaşırken “En Uyumlu” seçeneğiyle JPEG olarak gönderebilirsiniz. Dosya adı sunucuya gönderilmez.
