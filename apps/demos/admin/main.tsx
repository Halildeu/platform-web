    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="border rounded-lg p-4 bg-blue-50">
          ...
          <p className="text-sm text-gray-600">Genel ayarlar, tema, dil, bildirim tercihleri</p>
        </div>
        <div className="border rounded-lg p-4 bg-green-50">
          <h3 className="font-semibold">User Management</h3>
          <p className="text-sm text-gray-600">Kullanıcı listesi, rol atama, davet gönderme</p>
        </div>
        <div className="border rounded-lg p-4 bg-red-50">
          <h3 className="font-semibold">Security</h3>
          <p className="text-sm text-gray-600">SSO yapılandırma, audit log, oturum yönetimi</p>
        </div>
      </div>
    </section>
