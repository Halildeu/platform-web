...
export const MODULE_KEYS = {
   ...
   * Distinct from the OpenFGA tuple object id, which is kebab-case
   * `module:endpoint-admin` (see EndpointAdminAuthz.MODULE on the
   * backend). Auth-service is responsible for keeping the two in sync
   * per Faz 22.1.1b.
   */
