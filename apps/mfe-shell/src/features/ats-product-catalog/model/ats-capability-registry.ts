...
export const ATS_PRODUCT_ENTRY = {
...
/**
 * Shell-owned product catalog for the ATS entry surface.
 *
 * This registry deliberately describes what a user may discover when the
 * federated product remote is unavailable. It does not activate a remote,
 * widen OpenFGA authorization or claim production readiness. The shell may
 * render the safePreview text only; real candidate data and mutations remain
 * owned by the protected Interview Evidence MFE and its backend gates.
 */
export const ATS_CAPABILITY_REGISTRY = [
  {
    ...
    route: ATS_PRODUCT_ENTRY.route,
    requiredModule: ATS_PRODUCT_ENTRY.requiredModule,
