...
// `unwrapRequestFetchFn` (the `Request`-object header-drop workaround) was
// extracted to ./notify-request-fetch-fn.ts so the preferences + push RTK
// clients reuse it — Codex 019e50ac/019e5112 re-smoke caught those two
// clients 401'ing on cold-load because they lacked this fetchFn.
