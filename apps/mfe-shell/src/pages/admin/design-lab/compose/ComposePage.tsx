            ...
            <div className="flex items-center gap-1 ml-2">
              ...
              {[2, 3, 4].map((c) => (
                <button
                  ...
                  className={`rounded px-1.5 py-0.5 text-[10px] font-medium ${layout.columns === c ? "bg-action-primary text-white" : "bg-surface-muted text-text-secondary"}`}
                >
                  {c}
                </button>
              ))}
          ...
          <div className="flex items-center gap-1 ml-2">
            ...
            {[2, 4, 6, 8].map((g) => (
              <button
                ...
                className={`rounded px-1.5 py-0.5 text-[10px] font-medium ${layout.gap === g ? "bg-action-primary text-white" : "bg-surface-muted text-text-secondary"}`}
              >
                {g}
              </button>
            ))}
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            ...
            <div className="flex items-center gap-1 mb-2">
              <button
                ...
                className="rounded p-1 text-text-tertiary hover:text-text-primary hover:bg-surface-muted transition text-[10px]"
              >
                Move Up
              </button>
              <button
              ...
              <button
                ...
                className="ml-auto rounded p-1 text-red-400 hover:text-red-500 hover:bg-red-50 transition"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md rounded-2xl border border-border-subtle bg-surface-default shadow-2xl">
            <div className="flex items-center justify-between border-b border-border-subtle px-4 py-3">
              ...
              <button type="button" onClick={() => setShowLibrary(false)} className="rounded p-1 text-text-tertiary hover:text-text-primary">
                <X className="h-4 w-4" />
              </button>
            </div>
