        ...
        <div>
          ...
          <div className="mt-3 space-y-2">
            {data.topErrors.map((err, i) => (
              ...
              >
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded bg-rose-100 text-[10px] font-bold text-rose-700">
                  {err.count}
                </span>
    ...
    <div className="space-y-8 pb-12">
      ...
      <section className="rounded-2xl border border-border-subtle bg-surface-default p-6">
        ...
        <div className="mt-4 rounded-xl bg-surface-muted p-4 text-sm text-text-secondary">
          <p>
            Synthetic monitor{' '}
            <code className="rounded bg-surface-canvas px-1.5 py-0.5 text-xs font-mono">
