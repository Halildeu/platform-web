...
// bootstrap to consumer-level side-effect imports. ChartDetail is part
// of the design-lab route tree (only reachable from /admin/design-lab/
// charts/:chartId), so importing the setup here keeps the AG Grid
// Enterprise bundle out of /login and /home cold loads.
//
// NOTE: this page contains AG Grid sample CODE inside the API tab
// (search for `<AgGridReact` in this file — the match is a string
// literal in a tutorial snippet, not an actual JSX element). The real
// design-lab grid renders live in showcase pages that import GridShell
// from @mfe/design-system/advanced/data-grid, which now requires this
// explicit setup import at the route entry.
...
/>`,
  ...
  'tree-chart': {
    ...
    name: 'TreeChart',
    description:
      'Hierarchical node-link tree with expand/collapse, orthogonal or radial layout. Org-chart and strict-hierarchy use-case.',
    importPath: "import { TreeChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
      ...
      },
      {
        ...
        required: false,
        default: "'LR'",
        description: "Direction for orthogonal layout. Ignored when `layout='radial'`.",
      },
      {
      ...
      },
      {
        ...
        required: false,
        default: 'true',
        description: 'Allow click-to-expand / collapse on nodes with children.',
      },
      {
        name: 'roam',
      ...
      },
      {
        ...
        required: false,
        default: '10',
        description: 'Node symbol pixel size.',
      },
      {
        name: 'showLabels',
        type: 'boolean',
        required: false,
        default: 'true',
        description: 'Show the node-name label next to each node.',
      },
      {
        name: 'size',
        type: 'ChartSize',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Custom formatter for displayed values (tooltip + a11y table).',
      },
      {
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Canonical cross-filter click callback.',
      },
      {
        name: 'theme',
        type: 'ChartThemePreference',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Anomaly summary list for SR announcement.',
      },
      {
        name: 'formatAnomalyAnnouncement',
        type: 'AnomalyAnnouncementFormatter',
...
/>`,
  ...
  'calendar-heatmap': {
    ...
    description:
      'GitHub-contributions-style daily calendar heatmap — one color-mapped cell per day on a month/week grid for activity-over-time density.',
    importPath: "import { CalendarHeatmap } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
        ...
        required: true,
        default: '—',
        description: 'Per-day values. Each `date` is an ISO `YYYY-MM-DD` string.',
      },
      {
        name: 'range',
      ...
      {
        name: 'orient',
        type: 'CalendarHeatmapOrient',
        required: false,
        default: "'horizontal'",
        description: 'Calendar layout direction.',
      },
      {
        name: 'startOfWeek',
        ...
        required: false,
        default: "'monday'",
        description: "First day of the week — `'monday'` or `'sunday'`.",
      },
      {
        name: 'colors',
        type: '[string, string]',
        ...
        description: 'Color gradient endpoints `[low, high]` for the visual map.',
      },
      {
        name: 'min',
        type: 'number',
        required: false,
        default: 'undefined',
        description: 'Minimum value for the color scale. Auto-detected when omitted.',
      },
      {
        name: 'max',
        type: 'number',
        required: false,
        default: 'undefined',
        description: 'Maximum value for the color scale. Auto-detected when omitted.',
      },
      {
        name: 'showValues',
        type: 'boolean',
      ...
      },
      {
        ...
        required: false,
        default: 'true',
        description: 'Show the visual-map legend.',
      },
      {
        name: 'size',
        type: 'ChartSize',
...
/>`,
  ...
  'polar-chart': {
    ...
    name: 'PolarChart',
    description:
      'Categorical radial chart — bar / line / scatter series on a polar coordinate system. Nightingale-rose and cyclical-pattern use-case.',
    importPath: "import { PolarChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
      ...
      {
        name: 'showAngleAxisLabel',
        type: 'boolean',
        required: false,
        default: 'true',
        description: 'Show the angle-axis category labels.',
      },
      {
        name: 'showRadiusAxisLabel',
        type: 'boolean',
        required: false,
        default: 'true',
        description: 'Show the radius-axis tick labels.',
      },
      {
        name: 'min',
        type: 'number',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Maximum value for the radius scale. Auto-detected when omitted.',
      },
      {
        name: 'size',
        type: 'ChartSize',
...
/>`,
  ...
  'theme-river-chart': {
    ...
    description:
      'Stream graph — a `themeRiver` series on a `singleAxis` time coordinate system. Category volume / share evolving across a time series.',
    importPath: "import { ThemeRiverChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
      ...
      },
      {
        ...
        required: false,
        default: 'true',
        description: 'Show the category-name label on each flow band.',
      },
      {
        name: 'size',
        type: 'ChartSize',
...
/>`,
  ...
  'gantt-chart': {
    ...
    name: 'GanttChart',
    description:
      'Project-schedule timeline — a `custom` series painting one task bar per row across a time x-axis, placed on its `category` lane. Phase / workstream scheduling.',
    importPath: "import { GanttChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
...
/>`,
  ...
  /* ---- PR-X campaign extensions (Codex thread 019e1e30 + 019e2119 + 019e2254) ---- */

  'box-plot-chart': {
    id: 'box-plot-chart',
    name: 'BoxPlotChart',
    description:
      'Statistical box-and-whisker distribution chart with five-number summary (min, Q1, median, Q3, max) plus optional outliers. Useful for compensation parity audit, latency percentile review, and any per-group distribution comparison.',
    importPath: "import { BoxPlotChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
        ...
        required: true,
        default: '—',
        description: 'Box-plot data points.',
      },
      {
        name: 'size',
        type: 'ChartSize',
      ...
      },
      {
        ...
        required: false,
        default: 'true',
        description: 'Show outlier scatter overlay.',
      },
      {
        name: 'boxWidth',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Custom value formatter for axis labels + tooltip.',
      },
      {
        name: 'animate',
        type: 'boolean',
        required: false,
        default: 'true',
        description: 'Animate box draw on mount.',
      },
      {
        name: 'colors',
        type: '{ box?: string; outlier?: string }',
        required: false,
        default: 'undefined',
        description: 'Override default chart colors (box stroke, outlier dots).',
      },
      {
        name: 'title',
        type: 'string',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Callback fired when a box (category) is clicked.',
      },
      {
        name: 'markups',
        type: 'ChartMarkup[]',
        required: false,
        default: 'undefined',
        description: 'Visual overlay markups — NO-OP on v1, forwarded to dev warning.',
      },
      {
        name: 'onMarkupClick',
        type: '(event: ChartMarkupClickEvent) => void',
        required: false,
        default: 'undefined',
        description: 'Callback fired when a markup overlay is clicked (NO-OP on v1).',
      },
      {
        name: 'theme',
        type: 'ChartThemePreference',
...
/>`,
  ...
  'candlestick-chart': {
    ...
    description:
      'Financial OHLC (open-high-low-close) candlestick chart with bullish (green) / bearish (red) color coding. Used for stock price ranges, crypto, and any time-series with daily open-close patterns.',
    importPath: "import { CandlestickChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
        ...
        required: true,
        default: '—',
        description: 'OHLC data points — one bar per `label` time slot.',
      },
      {
        name: 'size',
        type: 'ChartSize',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Color for bullish candles (close ≥ open). Defaults to a green token.',
      },
      {
        name: 'bearishColor',
        type: 'string',
        required: false,
        default: 'undefined',
        description: 'Color for bearish candles (close < open). Defaults to a red token.',
      },
      {
        name: 'valueFormatter',
        type: '(value: number) => string',
      ...
      },
      {
        ...
        required: false,
        default: 'true',
        description: 'Animate candles on mount.',
      },
      {
        name: 'title',
        type: 'string',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Callback fired when a candle is clicked.',
      },
      {
        name: 'markups',
        type: 'ChartMarkup[]',
        required: false,
        default: 'undefined',
        description: 'Visual overlay markups — NO-OP on v1, dev warning surfaces.',
      },
      {
        name: 'onMarkupClick',
        type: '(event: ChartMarkupClickEvent) => void',
...
/>`,
  ...
  'pictorial-bar-chart': {
    ...
    description:
      'Decorative pictogram bar chart that renders each bar as a tiled symbol (icon). Useful for infographic dashboards where the visual metaphor reinforces the metric (e.g. people-count → person icon).',
    importPath: "import { PictorialBarChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
        type: 'PictorialBarDataPoint[]',
        required: true,
        default: '—',
        description: 'Pictogram data points.',
      },
      {
        name: 'symbol',
        type: 'string',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Visual overlay markups — NO-OP on v1.',
      },
      {
        name: 'onMarkupClick',
        type: '(event: ChartMarkupClickEvent) => void',
...
/>`,
  ...
  'parallel-coordinates-chart': {
    ...
    description:
      'Multi-dimensional parallel-coordinates plot. Each row of data becomes a polyline across N axes, revealing correlation patterns across dimensions. Used for HR compensation equity analysis, multi-metric employee profiling.',
    importPath: "import { ParallelCoordinatesChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'data',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        default: 'false (true if `groupBy` set)',
        description: 'Show legend below the chart.',
      },
      {
        name: 'valueFormatter',
        ...
        required: false,
        default: 'undefined',
        description: 'Custom value formatter for value-axis labels + tooltip.',
      },
      {
        name: 'animate',
        type: 'boolean',
        required: false,
        default: 'true',
        description: 'Animate polylines on mount.',
      },
      {
        name: 'colors',
        type: 'string[]',
        required: false,
        default: 'undefined',
        description: 'Override default palette (used when `groupBy` set, one per group).',
      },
      {
        name: 'title',
        type: 'string',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Callback fired when a polyline is clicked.',
      },
      {
        name: 'markups',
        type: 'ChartMarkup[]',
...
/>`,
  ...
  'graph-chart': {
    ...
    name: 'GraphChart',
    description:
      'Network / entity-edge topology graph with force, circular, or pinned layouts. Used for Context Health DocGraph (doc-to-doc references), permission cascades, service dependency networks. Replaces bar charts that count graph metrics with the actual relationship structure.',
    importPath: "import { GraphChart } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'nodes',
      ...
      },
      {
        ...
        required: true,
        default: '—',
        description: 'Edges between nodes (referenced by `source` / `target` id).',
      },
      {
        name: 'categories',
        type: 'GraphCategory[]',
      ...
      },
      {
        ...
        required: false,
        default: '0.1',
        description: 'Force-layout gravity (pulls nodes toward center).',
      },
      {
        name: 'forceEdgeLength',
        type: 'number | [number, number]',
        required: false,
        default: '50',
        description: 'Force-layout edge length. Number or [min, max] range.',
      },
      {
        name: 'directed',
        type: 'boolean',
        required: false,
        default: 'true',
        description: 'Whether edges are directional (renders arrow head at target).',
      },
      {
        name: 'showLegend',
        type: 'boolean',
        required: false,
        default: 'true (if `categories` set)',
        description: 'Show legend for categories.',
      },
      {
        name: 'roam',
        type: "boolean | 'scale' | 'move'",
        required: false,
        default: 'true',
        description: 'Allow user to drag nodes.',
      },
      {
        name: 'symbol',
        type: 'string',
        required: false,
        default: "'circle'",
        description: 'Default symbol shape.',
      },
      {
        name: 'defaultSymbolSize',
        type: 'number',
        required: false,
        default: '30',
        description: 'Default symbol size when nodes lack explicit value/size.',
      },
      {
        name: 'size',
        type: 'ChartSize',
      ...
      },
      {
        ...
        required: false,
        default: 'true',
        description: 'Animate layout on mount.',
      },
      {
        name: 'colors',
        type: 'string[]',
        required: false,
        default: 'undefined',
        description: 'Override default palette (one color per category).',
      },
      {
        name: 'title',
        type: 'string',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Callback fired when a node or edge is clicked.',
      },
      {
        name: 'markups',
        type: 'ChartMarkup[]',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Custom value formatter (used in a11y data table).',
      },
      {
        name: 'theme',
        type: 'ChartThemePreference',
...
/>`,
  ...
  'geo-map': {
    ...
    name: 'GeoMap',
    description:
      'Geographic choropleth map for regional distribution visualizations. Map JSON (TR provinces, world, etc.) is CONSUMER-supplied via `ensureGeoMapRegistered(name, loader)`; this keeps payload off the x-charts bundle (Codex thread 019e2254 licensing + tree-shake discipline). Used for HR il bazlı yoğunluk, branch concentration, hiring funnel by city.',
    importPath: "import { GeoMap, ensureGeoMapRegistered } from '@mfe/x-charts';",
    tier: 'enterprise',
    props: [
      {
        name: 'mapName',
      ...
      {
        name: 'visualMap',
        type: 'GeoMapVisualMap',
        required: false,
        default: 'undefined',
        description: 'VisualMap (choropleth color gradient) config.',
      },
      {
        name: 'showLabels',
        type: 'boolean',
        required: false,
        default: 'false (dense maps get cluttered)',
        description: 'Show region labels on the map.',
      },
      {
        name: 'roam',
        type: "boolean | 'scale' | 'move'",
        required: false,
        default: 'true',
        description: 'Allow user to pan/zoom.',
      },
      {
        name: 'selectedMode',
        type: "boolean | 'single' | 'multiple'",
        required: false,
        default: 'false (no selection)',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Callback fired when a region is clicked.',
      },
      {
        name: 'markups',
        type: 'ChartMarkup[]',
      ...
      },
      {
        ...
        required: false,
        default: 'undefined',
        description: 'Callback for markup clicks (NO-OP on v1).',
      },
      {
        name: 'theme',
        type: 'ChartThemePreference',
