      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border-subtle bg-surface-default px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 rounded-lg border border-border-subtle p-0.5">
            <button type="button" onClick={zoomOut} className="rounded-xs p-1 text-text-secondary hover:bg-surface-canvas" title="Zoom out">
              <ZoomOut className="h-3.5 w-3.5" />
            </button>
            <span className="min-w-[3ch] text-center text-[10px] font-medium text-text-tertiary">
              {Math.round(zoom * 100)}%
            </span>
            <button type="button" onClick={zoomIn} className="rounded-xs p-1 text-text-secondary hover:bg-surface-canvas" title="Zoom in">
              <ZoomIn className="h-3.5 w-3.5" />
            </button>
            <button type="button" onClick={resetView} className="rounded-xs p-1 text-text-secondary hover:bg-surface-canvas" title="Reset">
