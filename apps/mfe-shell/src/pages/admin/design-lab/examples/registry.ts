...
export function KompaktListe() {
  ...
  return (
    <SearchFilterListing
      ...
      items={[
        <div key="1" className="flex justify-between p-2 border rounded text-sm">
          <span>auth-service</span><span className="text-green-600 text-xs">Calisiyor</span>
        </div>,
        <div key="2" className="flex justify-between p-2 border rounded text-sm">
          <span>payment-gateway</span><span className="text-green-600 text-xs">Calisiyor</span>
        </div>,
        <div key="3" className="flex justify-between p-2 border rounded text-sm">
...
export function Example() {
  return (
    <div className="flex items-center gap-2">
      <IconButton icon={<Heart />} label="Begeni" variant="primary" rounded />
      <IconButton icon={<Share2 />} label="Paylas" variant="secondary" rounded />
      <IconButton icon={<Bookmark />} label="Kaydediliyor" variant="outline" rounded loading />
    </div>
  );
}`,
