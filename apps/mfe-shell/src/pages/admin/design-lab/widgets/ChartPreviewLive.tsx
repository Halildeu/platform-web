      ...
      return (
        ...
        >
          <BarChart
            ...
            stacked={isOn(toggles, 'stacked', false)}
            showBackground={isOn(toggles, 'showBackground', false)}
            barGap={getOptStr(toggles, 'barGap')}
            barCategoryGap={getOptStr(toggles, 'barCategoryGap')}
            valueAxisMin={getOptNum(toggles, 'valueAxisMin')}
            valueAxisMax={getOptNum(toggles, 'valueAxisMax')}
      ...
      return (
        ...
        >
          <LineChart
            ...
            step={getOptStr(toggles, 'step') as 'start' | 'middle' | 'end' | undefined}
            connectNulls={isOn(toggles, 'connectNulls', false)}
            animate={isOn(toggles, 'animate', true)}
            valueFormatter={getValueFormatterPreset(getEnum(toggles, 'valueFormatter', 'raw'))}
            onDataPointClick={getCallbackPreset(getEnum(toggles, 'onDataPointClick', 'noop'))}
      ...
      return (
        ...
        >
          <PieChart
            ...
            roseType={getOptStr(toggles, 'roseType') as 'radius' | 'area' | undefined}
            animate={isOn(toggles, 'animate', true)}
            valueFormatter={getValueFormatterPreset(getEnum(toggles, 'valueFormatter', 'raw'))}
            onDataPointClick={getCallbackPreset(getEnum(toggles, 'onDataPointClick', 'noop'))}
            theme={themeOverride}
