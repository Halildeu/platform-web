        ...
        React.createElement("div", { className: "rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-default,#fff)] p-4" },
          ...
          React.createElement("div", { className: "flex flex-col gap-2" },
            React.createElement("div", { className: "flex items-center gap-2 rounded-lg bg-[var(--surface-muted)] px-3 py-2 text-xs cursor-pointer" },
              React.createElement("span", { className: "rounded-xs bg-[var(--action-primary,#2563eb)]/10 px-1.5 py-0.5 text-[10px] font-medium text-[var(--action-primary,#2563eb)]" }, "SIPARIS"),
            ...
            React.createElement("div", { className: "flex items-center gap-2 rounded-lg bg-[var(--surface-muted)] px-3 py-2 text-xs cursor-pointer" },
              React.createElement("span", { className: "rounded-xs bg-[var(--status-success,#16a34a)]/10 px-1.5 py-0.5 text-[10px] font-medium text-[var(--status-success,#16a34a)]" }, "KULLANICI"),
            ...
            React.createElement("div", { className: "flex items-center gap-2 rounded-lg bg-[var(--surface-muted)] px-3 py-2 text-xs cursor-pointer" },
              React.createElement("span", { className: "rounded-xs bg-[var(--status-warning,#d97706)]/10 px-1.5 py-0.5 text-[10px] font-medium text-[var(--status-warning,#d97706)]" }, "TALEP"),
