 ...
 *
 * Codex 019e6e10 iter-2 absorb: overlay-engine API aligned with canonical
 * BottomSheetDrawer pattern (useId layerId + object-param useFocusTrap +
 * object-param useSiblingIsolation + registerLayer(id, 'modal') +
 * useEscapeKey gated by layerId). Previous iter-1 absorb used the legacy
 * 2-arg shape which TypeScript and runtime both rejected.
 *
