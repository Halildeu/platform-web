...
const DICT_TR = {
  ...
  'endpointAdmin.drawer.deviceHealth.memory.total': 'Toplam Fiziksel',
  'endpointAdmin.drawer.deviceHealth.memory.available': 'Kullanılabilir',
  'endpointAdmin.drawer.deviceHealth.memory.commit': 'Commit (kullanılan / limit)',
...
const DICT_EN: Record<keyof typeof DICT_TR, string> = {
  ...
  'endpointAdmin.drawer.deviceHealth.memory.total': 'Total physical',
  'endpointAdmin.drawer.deviceHealth.memory.available': 'Available',
  'endpointAdmin.drawer.deviceHealth.memory.commit': 'Commit (used / limit)',
