...
const DICT_TR = {
  ...
  'endpointAdmin.nav.section.approvals': 'İşler & Onaylar',
  ...
  'endpointAdmin.nav.status': 'Filo Sağlığı',
  ...
  'endpointAdmin.nav.approvals': 'Onay Kutusu',
  'endpointAdmin.nav.enrollments': 'Cihaz Kaydı & TPM',
...
const DICT_EN: Record<keyof typeof DICT_TR, string> = {
  ...
  'endpointAdmin.nav.section.approvals': 'Jobs & Approvals',
  ...
  'endpointAdmin.nav.status': 'Fleet Health',
  ...
  'endpointAdmin.nav.approvals': 'Approval Inbox',
  'endpointAdmin.nav.enrollments': 'Enrollment & TPM',
